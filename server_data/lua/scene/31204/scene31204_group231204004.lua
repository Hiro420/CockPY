...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 24010101, pos = { x = 11.5, y = 0.0, z = -8.5 }, rot = { x = 0.0, y = 340.0, z = 0.0 }, level = 1, affix = { 1028, 1221 }, isElite = true, pose_id = 100 },
	{ config_id = 4002, monster_id = 24010101, pos = { x = -11.9, y = 0.0, z = -6.5 }, rot = { x = 0.0, y = 9.9, z = 0.0 }, level = 1, affix = { 1028, 1221 }, isElite = true, pose_id = 100 }
}
