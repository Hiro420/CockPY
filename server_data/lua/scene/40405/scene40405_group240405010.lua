...
monsters = {
	...
	{ config_id = 10012, monster_id = 20010501, pos = { x = 10.2, y = 0.0, z = -3.1 }, rot = { x = 0.0, y = 299.8, z = 0.0 }, level = 1, affix = { 1007, 1010 }, isElite = true },
...
-- 装置
gadgets = {
	{ config_id = 10020, gadget_id = 70900205, pos = { x = 9.9, y = -1.5, z = -3.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
