...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	...
	-- 改变指定group组230904001中， configid为1002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230904001, 1002, GadgetState.Default) then
			return -1
		end 
	
	-- 改变指定group组230904001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230904001, 1001, GadgetState.Default) then
			return -1
		end 
