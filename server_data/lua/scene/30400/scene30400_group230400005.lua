...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70360010, pos = { x = 0.2, y = 0.1, z = 4.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_5003(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 230400006, {6001,6002,6003,6004,6005,6006,6007,6008,6009,6010,6011,6012,6013,6014,6015,6017,6018,6019,6020,6029}, 30, 5, 5) then
		return -1
	end
	...
	-- 改变指定group组230400007中， configid为7001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230400007, 7001, GadgetState.GearStart) then
			return -1
		end 
