...
-- 怪物
monsters = {
	{ config_id = 8, monster_id = 21010201, pos = { x = 81.0, y = 4.0, z = -604.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, disableWander = true, pose_id = 0 }
}
...
-- 装置
gadgets = {
	{ config_id = 123, gadget_id = 70211012, pos = { x = 80.8, y = 4.0, z = -601.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, drop_tag = "战斗中级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
