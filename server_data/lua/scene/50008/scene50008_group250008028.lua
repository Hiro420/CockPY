...
-- 怪物
monsters = {
	{ config_id = 9, monster_id = 21010201, pos = { x = 81.4, y = 4.0, z = -649.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, disableWander = true, pose_id = 0 }
}
...
-- 装置
gadgets = {
	{ config_id = 124, gadget_id = 70211022, pos = { x = 81.4, y = 4.0, z = -645.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, drop_tag = "战斗高级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
