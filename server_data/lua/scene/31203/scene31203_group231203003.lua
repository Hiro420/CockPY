...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 22010101, pos = { x = 5.1, y = 0.0, z = -7.2 }, rot = { x = 0.0, y = 346.5, z = 0.0 }, level = 1, affix = { 1221 }, isElite = true, pose_id = 0 },
	{ config_id = 3002, monster_id = 22010204, pos = { x = -6.9, y = 0.0, z = -7.9 }, rot = { x = 0.0, y = 21.5, z = 0.0 }, level = 1, affix = { 1029, 1221 }, isElite = true, pose_id = 0 }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231203003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231203003, 6)
