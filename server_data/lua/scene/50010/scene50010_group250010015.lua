...
-- 怪物
monsters = {
	{ config_id = 8, monster_id = 21011001, pos = { x = 111.9, y = 8.9, z = -5.7 }, rot = { x = 0.0, y = 177.8, z = 0.0 }, level = 1, pose_id = 32 },
	{ config_id = 9, monster_id = 21011001, pos = { x = 113.6, y = 8.9, z = -5.6 }, rot = { x = 0.0, y = 179.0, z = 0.0 }, level = 1, pose_id = 32 }
}
...
-- 区域
regions = {
	{ config_id = 47, shape = RegionShape.SPHERE, radius = 2, pos = { x = 116.2, y = 7.0, z = -14.1 } }
}
