...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 21010201, pos = { x = 9.4, y = 0.5, z = -9.0 }, rot = { x = 0.0, y = 327.6, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4002, monster_id = 21010201, pos = { x = -9.2, y = 0.5, z = -8.7 }, rot = { x = 0.0, y = 27.7, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4003, monster_id = 21010201, pos = { x = -0.2, y = 0.5, z = -10.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4004, monster_id = 21010201, pos = { x = -13.5, y = 0.5, z = -5.6 }, rot = { x = 0.0, y = 33.8, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4005, monster_id = 21010201, pos = { x = 12.6, y = 0.5, z = -4.5 }, rot = { x = 0.0, y = 306.6, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4006, monster_id = 21010201, pos = { x = -15.6, y = 0.5, z = -6.1 }, rot = { x = 0.0, y = 51.8, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true, pose_id = 402 },
	{ config_id = 4007, monster_id = 21010201, pos = { x = 9.0, y = 0.5, z = -7.7 }, rot = { x = 0.0, y = 342.7, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4008, monster_id = 21010201, pos = { x = -0.5, y = 0.5, z = -10.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4009, monster_id = 21010201, pos = { x = -9.0, y = 0.5, z = -9.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4010, monster_id = 20010701, pos = { x = 8.0, y = 0.5, z = -12.2 }, rot = { x = 0.0, y = 335.6, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4011, monster_id = 20010601, pos = { x = -7.4, y = 0.5, z = -9.8 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4012, monster_id = 21010201, pos = { x = 4.7, y = 0.5, z = -5.2 }, rot = { x = 0.0, y = 344.4, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4013, monster_id = 21010201, pos = { x = -1.3, y = 0.5, z = -6.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4014, monster_id = 21010201, pos = { x = -8.6, y = 0.5, z = -4.0 }, rot = { x = 0.0, y = 21.1, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true },
	{ config_id = 4015, monster_id = 21030103, pos = { x = -0.3, y = 0.5, z = -14.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4016, monster_id = 21010201, pos = { x = 9.2, y = 0.5, z = -3.9 }, rot = { x = 0.0, y = 322.0, z = 0.0 }, level = 1, affix = { 1201 }, isElite = true },
	{ config_id = 4017, monster_id = 21010901, pos = { x = 12.6, y = 0.5, z = -9.5 }, rot = { x = 0.0, y = 338.7, z = 0.0 }, level = 1, affix = { 1031, 1201 }, isElite = true, pose_id = 32 }
}
...
-- 装置
gadgets = {
	{ config_id = 4018, gadget_id = 70900205, pos = { x = 6.5, y = -0.9, z = 2.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 4019, gadget_id = 70350035, pos = { x = -0.6, y = 0.2, z = 0.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 10 }
}
...
function action_EVENT_CHALLENGE_SUCCESS_4025(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230202005, 5001, GadgetState.GearAction1) then
		...
		if 0 ~= ScriptLib.KillGroupEntity(context, { group_id = 230202004, monsters = {}, gadgets = {4019} }) then
			return -1
		end
