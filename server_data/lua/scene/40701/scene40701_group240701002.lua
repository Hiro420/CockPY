...
-- 怪物
monsters = {
	{ config_id = 2001, monster_id = 20011401, pos = { x = 11.1, y = -0.1, z = -6.8 }, rot = { x = 0.0, y = 324.8, z = 0.0 }, level = 1 },
	...
	{ config_id = 2009, monster_id = 20011401, pos = { x = -11.3, y = 0.1, z = 10.3 }, rot = { x = 0.0, y = 127.9, z = 0.0 }, level = 1 },
	...
	{ config_id = 2012, monster_id = 20011401, pos = { x = -0.1, y = -0.1, z = 11.0 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1 },
	{ config_id = 2013, monster_id = 21011201, pos = { x = 0.0, y = 0.0, z = -12.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
...
function action_EVENT_CHALLENGE_FAIL_2025(context, evt)
	...
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 240701001, 1001, {7}) then
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240701001, suite = 1 }) then
			return -1
		end
