...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70340012, pos = { x = 0.0, y = 0.0, z = -46.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350008, pos = { x = 0.0, y = 3.3, z = -42.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
