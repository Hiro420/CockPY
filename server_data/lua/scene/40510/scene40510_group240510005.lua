...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 21010201, pos = { x = 6.1, y = 0.1, z = -7.6 }, rot = { x = 0.0, y = 346.5, z = 0.0 }, level = 1 },
	{ config_id = 5002, monster_id = 21010201, pos = { x = -7.1, y = 0.1, z = -7.6 }, rot = { x = 0.0, y = 21.5, z = 0.0 }, level = 1 },
	{ config_id = 5003, monster_id = 21010201, pos = { x = -6.7, y = 0.1, z = -12.6 }, rot = { x = 0.0, y = 18.6, z = 0.0 }, level = 1 },
	{ config_id = 5004, monster_id = 21010301, pos = { x = -0.2, y = 0.1, z = -14.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5005, monster_id = 21010301, pos = { x = 7.7, y = 0.1, z = -14.3 }, rot = { x = 0.0, y = 343.7, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 5006, monster_id = 20011001, pos = { x = -11.4, y = 0.1, z = -3.7 }, rot = { x = 0.0, y = 64.8, z = 0.0 }, level = 1 },
	{ config_id = 5007, monster_id = 20011001, pos = { x = 11.7, y = 0.1, z = -3.5 }, rot = { x = 0.0, y = 270.1, z = 0.0 }, level = 1 },
	{ config_id = 5008, monster_id = 20011101, pos = { x = -8.5, y = 0.1, z = 5.6 }, rot = { x = 0.0, y = 160.0, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 5009, monster_id = 20011001, pos = { x = 4.3, y = 0.1, z = -9.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5010, monster_id = 20011001, pos = { x = -6.0, y = 0.1, z = -10.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5011, monster_id = 21010401, pos = { x = 11.9, y = 0.1, z = -1.0 }, rot = { x = 0.0, y = 315.3, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true, pose_id = 0 },
	{ config_id = 5012, monster_id = 21010301, pos = { x = 11.4, y = 0.1, z = -10.7 }, rot = { x = 0.0, y = 322.1, z = 0.0 }, level = 1, pose_id = 0 },
	{ config_id = 5013, monster_id = 21010401, pos = { x = -0.6, y = 0.1, z = -12.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, pose_id = 0 },
	{ config_id = 5014, monster_id = 21010301, pos = { x = -13.1, y = 0.1, z = -7.8 }, rot = { x = 0.0, y = 50.2, z = 0.0 }, level = 1, pose_id = 0 },
	{ config_id = 5015, monster_id = 21010401, pos = { x = -14.6, y = 0.1, z = -0.2 }, rot = { x = 0.0, y = 76.2, z = 0.0 }, level = 1, pose_id = 0 },
	{ config_id = 5016, monster_id = 21020101, pos = { x = 0.0, y = 0.1, z = -8.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 5017, monster_id = 20011001, pos = { x = -11.6, y = 0.1, z = -0.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5018, monster_id = 20011001, pos = { x = 9.4, y = 0.1, z = -3.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5019, monster_id = 20011101, pos = { x = -1.8, y = 0.1, z = 6.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5020, monster_id = 20011001, pos = { x = 4.4, y = 0.1, z = 5.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5029, monster_id = 20011101, pos = { x = 7.2, y = 0.4, z = 5.7 }, rot = { x = 0.0, y = 254.1, z = 0.0 }, level = 1 },
	{ config_id = 5030, monster_id = 21030102, pos = { x = -4.8, y = 0.4, z = 11.2 }, rot = { x = 0.0, y = 141.5, z = 0.0 }, level = 1 },
	{ config_id = 5031, monster_id = 21010301, pos = { x = -0.2, y = 0.1, z = -7.8 }, rot = { x = 0.0, y = 359.5, z = 0.0 }, level = 1 },
	{ config_id = 5032, monster_id = 21010301, pos = { x = -10.7, y = 0.1, z = 9.0 }, rot = { x = 0.0, y = 129.7, z = 0.0 }, level = 1, pose_id = 0 },
	{ config_id = 5033, monster_id = 21010402, pos = { x = 10.0, y = 0.4, z = -10.0 }, rot = { x = 0.0, y = 314.3, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 5034, monster_id = 21010201, pos = { x = 10.6, y = 0.4, z = 1.3 }, rot = { x = 0.0, y = 287.4, z = 0.0 }, level = 1 },
	{ config_id = 5035, monster_id = 21010201, pos = { x = 0.8, y = 0.4, z = -11.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 5021, gadget_id = 70900205, pos = { x = 6.1, y = -1.3, z = 0.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5022, gadget_id = 70350035, pos = { x = 0.0, y = 0.1, z = 1.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
