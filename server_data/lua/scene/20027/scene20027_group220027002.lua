...
function action_EVENT_ANY_MONSTER_LIVE_37(context, evt)
	-- 开启或者关闭groupid为220027002中,configid为：3的怪物的ai，set为1是开启，为0是关闭
	if 0 ~= ScriptLib.SetMonsterAIByGroup(context, 0, 3, 220027002) then
	  return -1
	end
...
function action_EVENT_ENTER_REGION_38(context, evt)
	-- 开启或者关闭groupid为220027002中,configid为：3的怪物的ai，set为1是开启，为0是关闭
	if 0 ~= ScriptLib.SetMonsterAIByGroup(context, 1, 3, 220027002) then
	  return -1
	end
