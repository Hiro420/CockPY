...
-- 装置
gadgets = {
	{ config_id = 23001, gadget_id = 70211031, pos = { x = 131.3, y = -92.3, z = -201.2 }, rot = { x = 0.0, y = 269.6, z = 0.0 }, level = 1, chest_drop_id = 18010200, drop_count = 1, showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_DUNGEON_PASS_CHEST }
}
