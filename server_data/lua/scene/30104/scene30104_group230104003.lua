...
-- 怪物
monsters = {
	{ config_id = 3004, monster_id = 21020101, pos = { x = -4.6, y = 0.1, z = -14.8 }, rot = { x = 0.0, y = 9.0, z = 0.0 }, level = 1, affix = { 1201, 1211 }, isElite = true, pose_id = 0 },
	{ config_id = 3005, monster_id = 21020201, pos = { x = 4.7, y = 0.1, z = -16.3 }, rot = { x = 0.0, y = 341.5, z = 0.0 }, level = 1, affix = { 1201, 1211 }, isElite = true, pose_id = 0 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_3031(context, evt)
	...
	if 0 ~= ScriptLib.SetMonsterBattleByGroup(context, 1, 3004, 230104003) then
	  return -1
	end
	
	-- 通知groupid为230104003中,configid为：3005的怪物入战或者脱战，set为1是入战，为0是脱战
	if 0 ~= ScriptLib.SetMonsterBattleByGroup(context, 1, 3005, 230104003) then
	  return -1
	end
