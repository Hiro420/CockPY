...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70350023, pos = { x = -0.2, y = 0.0, z = -0.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 5004, gadget_id = 70900205, pos = { x = 7.1, y = -1.3, z = 1.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
