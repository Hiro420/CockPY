...
-- 怪物
monsters = {
	{ config_id = 1001, monster_id = 20010501, pos = { x = 9.9, y = 0.0, z = -1.3 }, rot = { x = 0.0, y = 207.2, z = 0.0 }, level = 1 },
	{ config_id = 1002, monster_id = 20010501, pos = { x = -11.2, y = 0.0, z = -1.5 }, rot = { x = 0.0, y = 75.1, z = 0.0 }, level = 1 },
	{ config_id = 1003, monster_id = 20010701, pos = { x = -2.3, y = 0.2, z = -3.4 }, rot = { x = 0.0, y = 91.1, z = 0.0 }, level = 1, affix = { 1006, 1009 }, isElite = true },
	{ config_id = 1006, monster_id = 20010601, pos = { x = -4.2, y = 0.0, z = -2.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1006, 1009 }, isElite = true },
	{ config_id = 1008, monster_id = 20010501, pos = { x = -6.8, y = 0.3, z = -8.6 }, rot = { x = 0.0, y = 50.4, z = 0.0 }, level = 1 },
	{ config_id = 1009, monster_id = 20010501, pos = { x = -6.0, y = 0.3, z = 8.3 }, rot = { x = 0.0, y = 112.8, z = 0.0 }, level = 1 },
	{ config_id = 1010, monster_id = 20010501, pos = { x = -8.1, y = 0.3, z = -5.5 }, rot = { x = 0.0, y = 68.2, z = 0.0 }, level = 1 },
	{ config_id = 1011, monster_id = 20010501, pos = { x = -9.0, y = 0.3, z = 5.4 }, rot = { x = 0.0, y = 124.5, z = 0.0 }, level = 1 },
	{ config_id = 1012, monster_id = 20010501, pos = { x = -5.4, y = 0.3, z = 0.7 }, rot = { x = 0.0, y = 78.9, z = 0.0 }, level = 1 },
	{ config_id = 1013, monster_id = 20010501, pos = { x = 0.5, y = 0.3, z = 8.9 }, rot = { x = 0.0, y = 153.6, z = 0.0 }, level = 1 },
	{ config_id = 1014, monster_id = 20010501, pos = { x = 1.0, y = 0.3, z = -6.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 1015, monster_id = 20010501, pos = { x = 5.9, y = 0.3, z = -2.7 }, rot = { x = 0.0, y = 297.0, z = 0.0 }, level = 1 },
	{ config_id = 1016, monster_id = 20010501, pos = { x = 6.8, y = 0.3, z = 6.1 }, rot = { x = 0.0, y = 249.1, z = 0.0 }, level = 1 },
	{ config_id = 1017, monster_id = 20010501, pos = { x = -5.5, y = 0.3, z = 2.8 }, rot = { x = 0.0, y = 95.7, z = 0.0 }, level = 1 },
	{ config_id = 1018, monster_id = 20010501, pos = { x = -2.6, y = 0.3, z = 7.7 }, rot = { x = 0.0, y = 162.1, z = 0.0 }, level = 1 },
	{ config_id = 1019, monster_id = 20010501, pos = { x = -0.6, y = 0.3, z = -5.6 }, rot = { x = 0.0, y = 343.1, z = 0.0 }, level = 1 },
	{ config_id = 1020, monster_id = 20010501, pos = { x = 4.2, y = 0.0, z = 7.1 }, rot = { x = 0.0, y = 207.2, z = 0.0 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 1007, gadget_id = 70900205, pos = { x = 9.9, y = -0.9, z = -3.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
suites = {
	{
		...
		gadgets = { 1007 },
		regions = { },
		triggers = { "ANY_MONSTER_LIVE_3", "ANY_MONSTER_DIE_4", "ANY_MONSTER_DIE_5", "ANY_MONSTER_DIE_6", "ANY_MONSTER_DIE_7", "ANY_MONSTER_DIE_8", "CHALLENGE_SUCCESS_10", "CHALLENGE_FAIL_11", "ANY_MONSTER_DIE_1004", "ANY_MONSTER_DIE_1005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_LIVE_3(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 160, 240400001, 17, 60, 15) then
		return -1
	end
...
function action_EVENT_CHALLENGE_SUCCESS_10(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240400007, 14, GadgetState.GearStop) then
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_11(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240400001, suite = 2 }) then
			return -1
		end
...
function condition_EVENT_ANY_MONSTER_DIE_1004(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240400001) ~= 0 then
		return false
	end
