...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21020201, pos = { x = 0.0, y = 0.0, z = -12.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1028, 1211 }, isElite = true },
	{ config_id = 3002, monster_id = 20011101, pos = { x = -0.1, y = 0.0, z = -9.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 3003, monster_id = 20011101, pos = { x = -11.1, y = 0.0, z = 0.0 }, rot = { x = 0.0, y = 90.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 3004, monster_id = 20011101, pos = { x = 11.6, y = 0.0, z = 0.0 }, rot = { x = 0.0, y = 270.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 3006, monster_id = 21020201, pos = { x = 0.0, y = 0.0, z = 12.5 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1, affix = { 1028, 1211 }, isElite = true }
}
...
-- 触发器
triggers = {
	{ name = "MONSTER_TIDE_DIE_3005", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "", condition = "condition_EVENT_MONSTER_TIDE_DIE_3005", action = "action_EVENT_MONSTER_TIDE_DIE_3005" },
...
function action_EVENT_MONSTER_TIDE_DIE_3005(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 2, 230704003, {3001}, 3, 1, 1) then
		return -1
	end
