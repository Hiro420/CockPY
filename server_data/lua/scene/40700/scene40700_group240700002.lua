...
monsters = {
	...
	{ config_id = 2002, monster_id = 20011401, pos = { x = 8.9, y = -0.1, z = 9.1 }, rot = { x = 0.0, y = 231.1, z = 0.0 }, level = 1 },
	...
	{ config_id = 2006, monster_id = 20011401, pos = { x = -0.1, y = -0.1, z = 11.1 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1 },
	{ config_id = 2007, monster_id = 20011401, pos = { x = 12.5, y = -0.2, z = -8.0 }, rot = { x = 0.0, y = 324.8, z = 0.0 }, level = 1 },
	{ config_id = 2008, monster_id = 20011401, pos = { x = 10.2, y = 0.0, z = 10.1 }, rot = { x = 0.0, y = 233.1, z = 0.0 }, level = 1 },
	{ config_id = 2009, monster_id = 20011401, pos = { x = -11.3, y = 0.1, z = 10.4 }, rot = { x = 0.0, y = 127.9, z = 0.0 }, level = 1 },
	{ config_id = 2010, monster_id = 20011401, pos = { x = -14.5, y = 0.2, z = -7.3 }, rot = { x = 0.0, y = 58.7, z = 0.0 }, level = 1 },
	{ config_id = 2011, monster_id = 20011501, pos = { x = 0.0, y = 0.0, z = -12.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 2012, monster_id = 20011401, pos = { x = -0.1, y = -0.1, z = 11.1 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1 },
	{ config_id = 2014, monster_id = 20011501, pos = { x = 10.3, y = -0.1, z = -0.3 }, rot = { x = 0.0, y = 270.0, z = 0.0 }, level = 1 },
	{ config_id = 2015, monster_id = 20011501, pos = { x = -12.2, y = -0.1, z = 0.1 }, rot = { x = 0.0, y = 90.0, z = 0.0 }, level = 1 },
	{ config_id = 2016, monster_id = 20011401, pos = { x = 12.5, y = -0.2, z = -8.0 }, rot = { x = 0.0, y = 324.8, z = 0.0 }, level = 1 },
	{ config_id = 2017, monster_id = 20011401, pos = { x = 10.2, y = 0.0, z = 10.1 }, rot = { x = 0.0, y = 233.1, z = 0.0 }, level = 1 },
	{ config_id = 2018, monster_id = 20011401, pos = { x = -11.3, y = 0.1, z = 10.4 }, rot = { x = 0.0, y = 127.9, z = 0.0 }, level = 1 },
	{ config_id = 2019, monster_id = 20011401, pos = { x = -14.5, y = 0.2, z = -7.3 }, rot = { x = 0.0, y = 58.7, z = 0.0 }, level = 1 },
	{ config_id = 2020, monster_id = 20011401, pos = { x = 0.0, y = 0.0, z = -12.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 2021, monster_id = 20011501, pos = { x = -0.1, y = -0.1, z = 11.1 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1 }
}
...
triggers = {
	...
	{ name = "ANY_MONSTER_DIE_2026", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_2026", action = "action_EVENT_ANY_MONSTER_DIE_2026" },
	{ name = "ANY_MONSTER_DIE_2027", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_2027", action = "action_EVENT_ANY_MONSTER_DIE_2027" },
	{ name = "ANY_MONSTER_DIE_2028", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_2028", action = "action_EVENT_ANY_MONSTER_DIE_2028" }
}
