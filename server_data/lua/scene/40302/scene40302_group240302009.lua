...
gadgets = {
	...
	{ config_id = 10, gadget_id = 70350008, pos = { x = -1.2, y = 2.7, z = -43.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 11, gadget_id = 70350008, pos = { x = -1.9, y = 2.7, z = -43.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 12, gadget_id = 70350008, pos = { x = 1.1, y = 2.7, z = -42.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 13, gadget_id = 70350008, pos = { x = 0.3, y = 2.7, z = -42.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 14, gadget_id = 70350008, pos = { x = -1.3, y = 2.5, z = -42.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 1.9, y = 2.5, z = -41.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
