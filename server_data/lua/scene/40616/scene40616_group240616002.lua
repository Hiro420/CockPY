...
-- 装置
gadgets = {
	{ config_id = 2001, gadget_id = 70360010, pos = { x = 0.9, y = 0.0, z = -1.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 2002, shape = RegionShape.SPHERE, radius = 5, pos = { x = -2.2, y = 0.1, z = 3.2 } },
	{ config_id = 2003, shape = RegionShape.SPHERE, radius = 5, pos = { x = 5.7, y = 0.1, z = 1.5 } }
}
