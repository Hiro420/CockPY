...
monsters = {
	...
	{ config_id = 3016, monster_id = 22010301, pos = { x = 1.0, y = 0.1, z = -7.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
...
-- 区域
regions = {
	{ config_id = 3022, shape = RegionShape.SPHERE, radius = 5, pos = { x = 0.5, y = 0.1, z = 1.2 } },
	{ config_id = 3023, shape = RegionShape.SPHERE, radius = 5, pos = { x = 3.9, y = 0.1, z = 3.5 } },
	{ config_id = 3024, shape = RegionShape.SPHERE, radius = 5, pos = { x = 7.0, y = 0.1, z = 5.6 } },
	{ config_id = 3025, shape = RegionShape.SPHERE, radius = 5, pos = { x = -5.3, y = 0.1, z = 2.3 } },
	{ config_id = 3026, shape = RegionShape.SPHERE, radius = 5, pos = { x = 4.6, y = 0.1, z = 6.2 } },
	{ config_id = 3027, shape = RegionShape.SPHERE, radius = 5, pos = { x = 8.0, y = 0.1, z = 3.1 } }
}
