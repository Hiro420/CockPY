...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21020101, pos = { x = 6.2, y = 0.0, z = -5.0 }, rot = { x = 0.0, y = 346.5, z = 0.0 }, level = 1, affix = { 1221 }, isElite = true },
	{ config_id = 3002, monster_id = 21020201, pos = { x = -7.1, y = 0.0, z = -5.1 }, rot = { x = 0.0, y = 21.5, z = 0.0 }, level = 1, affix = { 1028, 1221 }, isElite = true }
}
...
function condition_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 231200003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3037(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 231200003, 6)
