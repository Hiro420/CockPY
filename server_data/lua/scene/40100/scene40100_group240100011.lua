...
gadgets = {
	...
	{ config_id = 14, gadget_id = 70350008, pos = { x = 0.3, y = 2.9, z = -42.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 0.9, y = 2.9, z = -42.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 16, gadget_id = 70350008, pos = { x = -0.7, y = 2.9, z = -42.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 17, gadget_id = 70350008, pos = { x = 1.3, y = 2.9, z = -42.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 18, gadget_id = 70350008, pos = { x = -0.7, y = 2.9, z = -42.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 19, gadget_id = 70350008, pos = { x = 0.3, y = 2.9, z = -42.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
