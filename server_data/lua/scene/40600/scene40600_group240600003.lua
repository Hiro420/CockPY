...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20010801, pos = { x = 11.5, y = 0.1, z = -8.9 }, rot = { x = 0.0, y = 323.7, z = 0.0 }, level = 1 },
	{ config_id = 3002, monster_id = 20010801, pos = { x = -10.6, y = 0.1, z = -7.5 }, rot = { x = 0.0, y = 62.7, z = 0.0 }, level = 1 },
	{ config_id = 3003, monster_id = 20010801, pos = { x = -5.7, y = 0.1, z = -11.2 }, rot = { x = 0.0, y = 18.6, z = 0.0 }, level = 1 },
	{ config_id = 3004, monster_id = 20010801, pos = { x = 5.2, y = 0.1, z = -11.6 }, rot = { x = 0.0, y = 339.5, z = 0.0 }, level = 1 },
	{ config_id = 3005, monster_id = 20010901, pos = { x = 0.0, y = 0.1, z = -13.8 }, rot = { x = 0.0, y = 358.7, z = 0.0 }, level = 1 },
	{ config_id = 3006, monster_id = 20010801, pos = { x = -10.4, y = 0.1, z = -2.4 }, rot = { x = 0.0, y = 64.8, z = 0.0 }, level = 1 },
	{ config_id = 3007, monster_id = 20010801, pos = { x = 12.7, y = 0.1, z = -2.1 }, rot = { x = 0.0, y = 270.1, z = 0.0 }, level = 1 },
	{ config_id = 3008, monster_id = 20010801, pos = { x = 1.1, y = 0.1, z = 6.3 }, rot = { x = 0.0, y = 182.8, z = 0.0 }, level = 1 },
	{ config_id = 3009, monster_id = 20010801, pos = { x = 7.7, y = 0.1, z = -8.8 }, rot = { x = 0.0, y = 324.7, z = 0.0 }, level = 1 },
	{ config_id = 3010, monster_id = 20010901, pos = { x = -5.0, y = 0.1, z = -8.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 3011, monster_id = 20010901, pos = { x = 6.6, y = 0.1, z = 3.9 }, rot = { x = 0.0, y = 220.7, z = 0.0 }, level = 1 },
	{ config_id = 3013, monster_id = 21010901, pos = { x = 13.9, y = 0.1, z = -6.4 }, rot = { x = 0.0, y = 273.7, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 3014, monster_id = 21010901, pos = { x = -11.8, y = 0.1, z = 1.6 }, rot = { x = 0.0, y = 82.2, z = 0.0 }, level = 1 },
	{ config_id = 3015, monster_id = 20010901, pos = { x = -6.2, y = 0.1, z = -8.7 }, rot = { x = 0.0, y = 39.4, z = 0.0 }, level = 1 },
	{ config_id = 3016, monster_id = 22010204, pos = { x = -0.2, y = 0.1, z = -13.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 3017, monster_id = 20010801, pos = { x = -10.6, y = 0.1, z = 0.5 }, rot = { x = 0.0, y = 103.2, z = 0.0 }, level = 1 },
	{ config_id = 3018, monster_id = 20010801, pos = { x = 10.4, y = 0.1, z = -2.0 }, rot = { x = 0.0, y = 292.1, z = 0.0 }, level = 1 },
	{ config_id = 3019, monster_id = 20010801, pos = { x = -8.0, y = 0.1, z = 4.9 }, rot = { x = 0.0, y = 139.8, z = 0.0 }, level = 1 },
	{ config_id = 3020, monster_id = 20010801, pos = { x = 8.7, y = 0.1, z = 4.4 }, rot = { x = 0.0, y = 234.0, z = 0.0 }, level = 1 },
	{ config_id = 3028, monster_id = 20010801, pos = { x = -8.5, y = 0.1, z = 3.6 }, rot = { x = 0.0, y = 152.5, z = 0.0 }, level = 1 },
	{ config_id = 3029, monster_id = 20010801, pos = { x = 8.7, y = 0.1, z = 3.5 }, rot = { x = 0.0, y = 325.2, z = 0.0 }, level = 1 },
	{ config_id = 3030, monster_id = 20010801, pos = { x = -0.1, y = 0.1, z = 1.6 }, rot = { x = 0.0, y = 179.7, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true },
	{ config_id = 3031, monster_id = 20010801, pos = { x = -12.6, y = 0.1, z = -1.5 }, rot = { x = 0.0, y = 102.1, z = 0.0 }, level = 1 },
	{ config_id = 3032, monster_id = 20010901, pos = { x = 0.0, y = 0.1, z = 6.5 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1 },
	{ config_id = 3033, monster_id = 20010801, pos = { x = -3.7, y = 0.1, z = 3.8 }, rot = { x = 0.0, y = 133.6, z = 0.0 }, level = 1 },
	{ config_id = 3034, monster_id = 20010801, pos = { x = 3.7, y = 0.1, z = -8.8 }, rot = { x = 0.0, y = 319.0, z = 0.0 }, level = 1 },
	{ config_id = 3035, monster_id = 20010801, pos = { x = 12.8, y = 0.1, z = -2.1 }, rot = { x = 0.0, y = 179.7, z = 0.0 }, level = 1 },
	{ config_id = 3036, monster_id = 21010902, pos = { x = 0.0, y = 0.0, z = 12.8 }, rot = { x = 0.0, y = 182.5, z = 0.0 }, level = 1, affix = { 1031 }, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 3012, gadget_id = 70350035, pos = { x = 0.0, y = 0.0, z = -2.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
