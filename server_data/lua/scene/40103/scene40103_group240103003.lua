...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20011301, pos = { x = 7.5, y = 0.0, z = 0.4 }, rot = { x = 0.0, y = 306.3, z = 0.0 }, level = 1 },
	{ config_id = 3002, monster_id = 20011301, pos = { x = -7.6, y = 0.0, z = 0.3 }, rot = { x = 0.0, y = 30.2, z = 0.0 }, level = 1 },
	{ config_id = 3003, monster_id = 21011001, pos = { x = -0.3, y = 0.0, z = -11.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true, pose_id = 32 },
	{ config_id = 3004, monster_id = 21011001, pos = { x = 8.2, y = 0.0, z = 11.4 }, rot = { x = 0.0, y = 192.6, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true, pose_id = 32 },
	{ config_id = 3005, monster_id = 21011001, pos = { x = -7.8, y = 0.0, z = 11.1 }, rot = { x = 0.0, y = 147.4, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true, pose_id = 32 },
	{ config_id = 3006, monster_id = 22010101, pos = { x = -0.2, y = 0.2, z = -4.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 4, affix = { 1006, 1013 }, isElite = true },
	{ config_id = 3007, monster_id = 20030101, pos = { x = 12.5, y = 0.4, z = 3.2 }, rot = { x = 0.0, y = 279.7, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true },
	{ config_id = 3008, monster_id = 20030101, pos = { x = -9.8, y = 0.2, z = 4.7 }, rot = { x = 0.0, y = 114.1, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true },
	{ config_id = 3009, monster_id = 20030101, pos = { x = 6.1, y = 0.0, z = 12.1 }, rot = { x = 0.0, y = 185.5, z = 0.0 }, level = 1, affix = { 1001 }, isElite = true },
	{ config_id = 3014, monster_id = 20011201, pos = { x = 8.7, y = 0.1, z = 10.3 }, rot = { x = 0.0, y = 199.6, z = 0.0 }, level = 1 },
	{ config_id = 3015, monster_id = 20011201, pos = { x = 10.2, y = 0.1, z = -4.4 }, rot = { x = 0.0, y = 308.7, z = 0.0 }, level = 1 },
	{ config_id = 3016, monster_id = 20011201, pos = { x = -12.0, y = 0.1, z = -5.4 }, rot = { x = 0.0, y = 57.6, z = 0.0 }, level = 1 },
	{ config_id = 3017, monster_id = 20011201, pos = { x = -8.7, y = 0.1, z = 9.9 }, rot = { x = 0.0, y = 139.5, z = 0.0 }, level = 1 },
	{ config_id = 3018, monster_id = 20011301, pos = { x = -0.4, y = 0.1, z = -11.7 }, rot = { x = 0.0, y = 2.0, z = 0.0 }, level = 1 },
	{ config_id = 3019, monster_id = 20030101, pos = { x = -11.2, y = 0.1, z = -3.2 }, rot = { x = 0.0, y = 47.2, z = 0.0 }, level = 1 },
	{ config_id = 3020, monster_id = 20030101, pos = { x = 9.2, y = 0.1, z = 9.6 }, rot = { x = 0.0, y = 202.0, z = 0.0 }, level = 1 },
	{ config_id = 3021, monster_id = 20011201, pos = { x = 8.6, y = 0.1, z = -5.1 }, rot = { x = 0.0, y = 311.5, z = 0.0 }, level = 1 },
	{ config_id = 3022, monster_id = 20011201, pos = { x = -8.9, y = 0.1, z = 9.3 }, rot = { x = 0.0, y = 148.0, z = 0.0 }, level = 1 },
	{ config_id = 3023, monster_id = 20011301, pos = { x = -1.6, y = 0.0, z = -8.5 }, rot = { x = 0.0, y = 2.0, z = 0.0 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 3010, gadget_id = 70900205, pos = { x = 3.0, y = -1.3, z = 9.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
