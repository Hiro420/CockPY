...
-- 怪物
monsters = {
	{ config_id = 6001, monster_id = 21010201, pos = { x = 10.0, y = 0.4, z = 7.0 }, rot = { x = 0.0, y = 228.3, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6002, monster_id = 21010201, pos = { x = -9.5, y = 0.4, z = 6.6 }, rot = { x = 0.0, y = 137.3, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6003, monster_id = 21010201, pos = { x = -7.6, y = 0.4, z = -7.8 }, rot = { x = 0.0, y = 51.5, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6004, monster_id = 21010501, pos = { x = 9.8, y = 0.4, z = 0.1 }, rot = { x = 0.0, y = 270.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6005, monster_id = 21010201, pos = { x = 7.5, y = 0.4, z = -7.6 }, rot = { x = 0.0, y = 312.4, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6006, monster_id = 21010201, pos = { x = 4.1, y = 0.4, z = 11.3 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6007, monster_id = 20011101, pos = { x = 0.0, y = 0.4, z = -9.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6009, monster_id = 21010201, pos = { x = -4.6, y = 0.4, z = 11.5 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6010, monster_id = 20011101, pos = { x = 0.0, y = 0.4, z = 10.3 }, rot = { x = 0.0, y = 180.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true },
	{ config_id = 6021, monster_id = 21010501, pos = { x = -9.9, y = 0.4, z = 0.1 }, rot = { x = 0.0, y = 90.0, z = 0.0 }, level = 1, affix = { 1211 }, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 6008, gadget_id = 70900205, pos = { x = 6.7, y = -1.0, z = 3.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
