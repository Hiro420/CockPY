...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 70350023, pos = { x = 0.0, y = 0.0, z = 0.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_7003(context, evt)
	...
	-- 改变指定group组230801004中， configid为4002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230801004, 4002, GadgetState.Default) then
			return -1
		end 
	
	-- 改变指定group组230801004中， configid为4001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230801004, 4001, GadgetState.Default) then
			return -1
		end 
