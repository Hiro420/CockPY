...
triggers = {
	...
	{ name = "SELECT_OPTION_74", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_74", action = "action_EVENT_SELECT_OPTION_74", trigger_count = 0, forbid_guest = false }
}
