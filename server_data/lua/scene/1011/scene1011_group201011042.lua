...
triggers = {
	...
	{ name = "SELECT_OPTION_110", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_110", action = "action_EVENT_SELECT_OPTION_110", trigger_count = 0, forbid_guest = false }
}
