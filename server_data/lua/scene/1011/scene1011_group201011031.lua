...
triggers = {
	...
	{ name = "SELECT_OPTION_88", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_88", action = "action_EVENT_SELECT_OPTION_88", trigger_count = 0, forbid_guest = false }
}
