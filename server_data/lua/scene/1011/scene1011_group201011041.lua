...
triggers = {
	...
	{ name = "SELECT_OPTION_108", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_108", action = "action_EVENT_SELECT_OPTION_108", trigger_count = 0, forbid_guest = false }
}
