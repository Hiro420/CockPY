...
triggers = {
	...
	{ name = "SELECT_OPTION_70", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_70", action = "action_EVENT_SELECT_OPTION_70", trigger_count = 0, forbid_guest = false }
}
