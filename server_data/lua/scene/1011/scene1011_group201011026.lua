...
triggers = {
	...
	{ name = "SELECT_OPTION_78", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_78", action = "action_EVENT_SELECT_OPTION_78", trigger_count = 0, forbid_guest = false }
}
