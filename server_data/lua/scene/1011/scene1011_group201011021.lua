...
triggers = {
	...
	{ name = "SELECT_OPTION_68", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_68", action = "action_EVENT_SELECT_OPTION_68", trigger_count = 0, forbid_guest = false }
}
