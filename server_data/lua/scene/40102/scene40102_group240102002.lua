...
-- 装置
gadgets = {
	{ config_id = 20, gadget_id = 70900205, pos = { x = 9.3, y = -1.1, z = 4.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_6(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 2, 157, 180, 240102002, 6, 0) then
		return -1
	end
