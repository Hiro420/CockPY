...
gadgets = {
	...
	{ config_id = 14, gadget_id = 70350008, pos = { x = 1.2, y = 3.2, z = -42.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 15, gadget_id = 70350008, pos = { x = 0.4, y = 3.2, z = -42.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 16, gadget_id = 70350008, pos = { x = 1.6, y = 3.2, z = -42.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 17, gadget_id = 70350008, pos = { x = 0.4, y = 3.2, z = -42.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 18, gadget_id = 70350008, pos = { x = 0.4, y = 3.2, z = -42.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 19, gadget_id = 70350008, pos = { x = -0.4, y = 3.2, z = -42.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
