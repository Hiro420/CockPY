...
function action_EVENT_SELECT_OPTION_5003(context, evt)
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 230703006, {6001,6002,6011,6012,6007,6003,6004}, 20, 4, 4) then
		return -1
	end
	
	-- 创建编号为2（该怪物潮的识别id)的怪物潮，创建怪物总数为5，场上怪物最少1只，最多1只
	if 0 ~= ScriptLib.AutoMonsterTide(context, 2, 230703006, {6005,6006}, 5, 1, 1) then
		return -1
	end
...
function action_EVENT_SELECT_OPTION_5004(context, evt)
	...
	-- 创建编号为1（该怪物潮的识别id)的怪物潮，创建怪物总数为20，场上怪物最少4只，最多4只
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 230703007, {7001,7002,7003,7004,7012,7013,7014}, 20, 4, 4) then
		return -1
	end
	
	-- 创建编号为2（该怪物潮的识别id)的怪物潮，创建怪物总数为5，场上怪物最少1只，最多1只
	if 0 ~= ScriptLib.AutoMonsterTide(context, 2, 230703007, {7005,7006}, 5, 1, 1) then
		return -1
	end
