...
gadgets = {
	...
	{ config_id = 124, gadget_id = 70211001, pos = { x = -66.7, y = -80.2, z = -213.1 }, rot = { x = 0.0, y = 331.3, z = 0.0 }, level = 1, drop_tag = "战斗低级蒙德", type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 100, 101, 102, 103, 104, 105, 106, 123, 124 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
