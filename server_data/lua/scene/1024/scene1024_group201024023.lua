...
-- 装置
gadgets = {
	{ config_id = 23001, gadget_id = 70211031, pos = { x = 131.1, y = -92.3, z = -201.1 }, rot = { x = 0.0, y = 269.4, z = 0.0 }, level = 1, chest_drop_id = 18010000, drop_count = 1, isOneoff = true, persistent = true, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
