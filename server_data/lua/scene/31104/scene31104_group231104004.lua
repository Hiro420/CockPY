...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 22010202, pos = { x = 2.7, y = 0.0, z = -12.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1029, 1221 }, isElite = true },
	{ config_id = 4002, monster_id = 21030103, pos = { x = -0.3, y = 0.0, z = -14.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1221 }, isElite = true },
	{ config_id = 4003, monster_id = 21020101, pos = { x = -3.3, y = 0.0, z = -12.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, affix = { 1221 }, isElite = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_4013(context, evt)
	...
	-- 从231104001的变量TPL_TIME中取出对应值并开启挑战
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 231104004, 3, 0) then
	    return -1
	  end
