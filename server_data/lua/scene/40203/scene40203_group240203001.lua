...
-- 怪物
monsters = {
	{ config_id = 1001, monster_id = 20010801, pos = { x = -6.7, y = 0.0, z = 11.9 }, rot = { x = 0.0, y = 106.2, z = 0.0 }, level = 1 },
	{ config_id = 1002, monster_id = 20010801, pos = { x = 7.0, y = 0.0, z = -3.1 }, rot = { x = 0.0, y = 308.8, z = 0.0 }, level = 1 },
	{ config_id = 1003, monster_id = 20010801, pos = { x = 8.0, y = 0.0, z = 9.8 }, rot = { x = 0.0, y = 226.8, z = 0.0 }, level = 1 },
	{ config_id = 1004, monster_id = 20010901, pos = { x = -2.2, y = 0.0, z = -10.4 }, rot = { x = 0.0, y = 358.1, z = 0.0 }, level = 1 },
	{ config_id = 1005, monster_id = 22010201, pos = { x = -0.2, y = -0.1, z = -7.2 }, rot = { x = 0.0, y = 355.3, z = 0.0 }, level = 3, affix = { 1008, 1014 }, isElite = true },
	{ config_id = 1006, monster_id = 21011001, pos = { x = -12.4, y = -0.1, z = -7.1 }, rot = { x = 0.0, y = 46.5, z = 0.0 }, level = 1, pose_id = 32 },
	{ config_id = 1007, monster_id = 21011001, pos = { x = 9.4, y = -0.1, z = -5.9 }, rot = { x = 0.0, y = 306.6, z = 0.0 }, level = 1, pose_id = 32 },
	{ config_id = 1008, monster_id = 21011001, pos = { x = 8.7, y = 0.0, z = 11.3 }, rot = { x = 0.0, y = 199.7, z = 0.0 }, level = 1, pose_id = 32 },
	{ config_id = 1009, monster_id = 21011001, pos = { x = -9.5, y = 0.0, z = 10.1 }, rot = { x = 0.0, y = 133.3, z = 0.0 }, level = 1, pose_id = 32 },
	{ config_id = 1013, monster_id = 20010801, pos = { x = -9.7, y = 0.0, z = -6.2 }, rot = { x = 0.0, y = 52.0, z = 0.0 }, level = 1 },
	{ config_id = 1014, monster_id = 20010801, pos = { x = -8.6, y = 0.0, z = 10.4 }, rot = { x = 0.0, y = 106.2, z = 0.0 }, level = 1 },
	{ config_id = 1015, monster_id = 20010801, pos = { x = 7.8, y = 0.0, z = -5.1 }, rot = { x = 0.0, y = 308.8, z = 0.0 }, level = 1 },
	{ config_id = 1016, monster_id = 20010801, pos = { x = 6.7, y = 0.0, z = 9.7 }, rot = { x = 0.0, y = 226.8, z = 0.0 }, level = 1 },
	{ config_id = 1017, monster_id = 20010901, pos = { x = 0.1, y = 0.0, z = -11.0 }, rot = { x = 0.0, y = 358.1, z = 0.0 }, level = 1, affix = { 1008, 1013 }, isElite = true },
	{ config_id = 1018, monster_id = 20010801, pos = { x = 9.8, y = 0.0, z = -3.6 }, rot = { x = 0.0, y = 301.6, z = 0.0 }, level = 1 },
	{ config_id = 1019, monster_id = 20010801, pos = { x = 7.8, y = 0.0, z = 10.9 }, rot = { x = 0.0, y = 223.7, z = 0.0 }, level = 1 },
	{ config_id = 1020, monster_id = 20010801, pos = { x = -10.5, y = 0.0, z = -6.1 }, rot = { x = 0.0, y = 41.9, z = 0.0 }, level = 1 },
	{ config_id = 1021, monster_id = 20030101, pos = { x = -0.3, y = 0.0, z = 12.4 }, rot = { x = 0.0, y = 129.3, z = 0.0 }, level = 1 },
	{ config_id = 1022, monster_id = 20030101, pos = { x = -8.4, y = 0.0, z = 7.1 }, rot = { x = 0.0, y = 142.4, z = 0.0 }, level = 1 },
	{ config_id = 1023, monster_id = 20010801, pos = { x = -11.2, y = 0.0, z = -4.5 }, rot = { x = 0.0, y = 52.0, z = 0.0 }, level = 1 }
}
...
-- 装置
gadgets = {
	{ config_id = 1010, gadget_id = 70900205, pos = { x = 9.8, y = -1.7, z = 4.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_12(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 162, 240203001, 20, 120, 25) then
		return -1
	end
...
function condition_EVENT_ANY_MONSTER_DIE_1011(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240203001) ~= 0 then
		return false
	end
