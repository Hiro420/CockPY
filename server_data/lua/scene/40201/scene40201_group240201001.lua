...
-- 怪物
monsters = {
	{ config_id = 1001, monster_id = 20030101, pos = { x = -4.6, y = -0.1, z = -6.8 }, rot = { x = 0.0, y = 108.3, z = 0.0 }, level = 1, affix = { 1006 }, isElite = true },
	{ config_id = 1002, monster_id = 20030101, pos = { x = 4.2, y = -0.1, z = -6.9 }, rot = { x = 0.0, y = 58.3, z = 0.0 }, level = 1, affix = { 1006 }, isElite = true },
	{ config_id = 1003, monster_id = 20010801, pos = { x = -10.2, y = 0.0, z = -2.9 }, rot = { x = 0.0, y = 52.0, z = 0.0 }, level = 1 },
	{ config_id = 1004, monster_id = 20030101, pos = { x = -4.1, y = 0.0, z = 10.2 }, rot = { x = 0.0, y = 106.2, z = 0.0 }, level = 1, affix = { 1006 }, isElite = true },
	{ config_id = 1005, monster_id = 20010801, pos = { x = 10.3, y = 0.0, z = -0.2 }, rot = { x = 0.0, y = 264.3, z = 0.0 }, level = 1 },
	{ config_id = 1006, monster_id = 20010801, pos = { x = 6.2, y = 0.0, z = 9.8 }, rot = { x = 0.0, y = 204.7, z = 0.0 }, level = 1 },
	{ config_id = 1007, monster_id = 20010901, pos = { x = -2.4, y = 0.0, z = -11.3 }, rot = { x = 0.0, y = 4.4, z = 0.0 }, level = 1 },
	{ config_id = 1011, monster_id = 20010801, pos = { x = -9.9, y = 0.0, z = -5.4 }, rot = { x = 0.0, y = 52.0, z = 0.0 }, level = 1 },
	{ config_id = 1012, monster_id = 20010801, pos = { x = -5.7, y = 0.0, z = 9.5 }, rot = { x = 0.0, y = 106.2, z = 0.0 }, level = 1 },
	{ config_id = 1013, monster_id = 20010801, pos = { x = 11.3, y = 0.0, z = -2.1 }, rot = { x = 0.0, y = 264.3, z = 0.0 }, level = 1 },
	{ config_id = 1014, monster_id = 20010801, pos = { x = 7.2, y = 0.0, z = 8.8 }, rot = { x = 0.0, y = 204.7, z = 0.0 }, level = 1 },
	{ config_id = 1015, monster_id = 20010901, pos = { x = -0.2, y = 0.0, z = -11.7 }, rot = { x = 0.0, y = 4.4, z = 0.0 }, level = 1 },
	{ config_id = 1016, monster_id = 20030101, pos = { x = 6.2, y = 0.0, z = -1.9 }, rot = { x = 0.0, y = 301.6, z = 0.0 }, level = 1, affix = { 1006 }, isElite = true },
	{ config_id = 1017, monster_id = 20010801, pos = { x = 5.8, y = 0.0, z = 12.3 }, rot = { x = 0.0, y = 223.7, z = 0.0 }, level = 1 },
	{ config_id = 1018, monster_id = 20010801, pos = { x = 6.7, y = 0.0, z = 5.0 }, rot = { x = 0.0, y = 265.3, z = 0.0 }, level = 1 },
	{ config_id = 1019, monster_id = 20010801, pos = { x = -0.3, y = 0.0, z = 12.4 }, rot = { x = 0.0, y = 129.3, z = 0.0 }, level = 1 },
	{ config_id = 1020, monster_id = 20010801, pos = { x = 2.0, y = 0.0, z = -2.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 1021, monster_id = 22010201, pos = { x = -0.2, y = -0.1, z = -7.2 }, rot = { x = 0.0, y = 355.3, z = 0.0 }, level = 3, affix = { 1006, 1012 }, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 1008, gadget_id = 70900205, pos = { x = 8.1, y = -1.2, z = 7.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
suites = {
	{
		...
		gadgets = { 1008 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_3", "ANY_MONSTER_DIE_4", "ANY_MONSTER_DIE_5", "ANY_MONSTER_DIE_6", "ANY_MONSTER_DIE_7", "ANY_MONSTER_LIVE_12", "CHALLENGE_FAIL_14", "ANY_MONSTER_DIE_1009", "ANY_MONSTER_DIE_1010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_LIVE_12(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 162, 240201001, 18, 100, 20) then
		return -1
	end
...
function action_EVENT_CHALLENGE_FAIL_14(context, evt)
	...
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 240201002, 1, {7}) then
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240201001, suite = 2 }) then
			return -1
		end
...
function condition_EVENT_ANY_MONSTER_DIE_1009(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240201001) ~= 0 then
		return false
	end
