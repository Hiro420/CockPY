...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70360010, pos = { x = 0.1, y = 0.1, z = 7.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_5003(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 230504007, 7001, GadgetState.GearStart) then
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 230504008, suite = 1 }) then
			return -1
		end
