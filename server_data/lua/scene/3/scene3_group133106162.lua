...
-- 怪物
monsters = {
	{ config_id = 162001, monster_id = 28050201, pos = { x = -100.9, y = 199.1, z = 986.4 }, rot = { x = 355.6, y = 128.5, z = 11.1 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 162002, monster_id = 28050201, pos = { x = -94.7, y = 199.6, z = 970.8 }, rot = { x = 353.6, y = 122.4, z = 19.6 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 162003, gadget_id = 70360027, pos = { x = -94.6, y = 199.6, z = 970.9 }, rot = { x = 5.8, y = 104.4, z = 5.0 }, level = 32 },
	{ config_id = 162004, gadget_id = 70360015, pos = { x = -100.6, y = 198.9, z = 986.5 }, rot = { x = 11.9, y = 15.1, z = 359.5 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_162005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_162005", action = "action_EVENT_ANY_MONSTER_DIE_162005" },
	{ name = "SELECT_OPTION_162006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_162006", action = "action_EVENT_SELECT_OPTION_162006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_162007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_162007", action = "action_EVENT_GADGET_STATE_CHANGE_162007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_162008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_162008", action = "action_EVENT_GADGET_STATE_CHANGE_162008", trigger_count = 0 },
	{ name = "GROUP_LOAD_162009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_162009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_162010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_162010", action = "action_EVENT_GADGET_STATE_CHANGE_162010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_162005", "SELECT_OPTION_162006", "GADGET_STATE_CHANGE_162007", "GADGET_STATE_CHANGE_162008", "GROUP_LOAD_162009", "GADGET_STATE_CHANGE_162010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_162005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133106162, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_162010(context, evt)
	if 162004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
