...
-- 怪物
monsters = {
	{ config_id = 537001, monster_id = 28050201, pos = { x = 475.5, y = 227.1, z = 975.3 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 537002, monster_id = 28050201, pos = { x = 484.4, y = 227.6, z = 964.3 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 537003, gadget_id = 70360027, pos = { x = 484.5, y = 227.6, z = 964.2 }, rot = { x = 0.0, y = 104.1, z = 0.0 }, level = 32 },
	{ config_id = 537004, gadget_id = 70360015, pos = { x = 475.8, y = 227.0, z = 975.4 }, rot = { x = 0.0, y = 15.1, z = 0.0 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_537005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_537005", action = "action_EVENT_ANY_MONSTER_DIE_537005" },
	{ name = "SELECT_OPTION_537006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_537006", action = "action_EVENT_SELECT_OPTION_537006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_537007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_537007", action = "action_EVENT_GADGET_STATE_CHANGE_537007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_537008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_537008", action = "action_EVENT_GADGET_STATE_CHANGE_537008", trigger_count = 0 },
	{ name = "GROUP_LOAD_537009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_537009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_537010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_537010", action = "action_EVENT_GADGET_STATE_CHANGE_537010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_537005", "SELECT_OPTION_537006", "GADGET_STATE_CHANGE_537007", "GADGET_STATE_CHANGE_537008", "GROUP_LOAD_537009", "GADGET_STATE_CHANGE_537010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_537005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133104537, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_537010(context, evt)
	if 537004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_537010(context, evt)
