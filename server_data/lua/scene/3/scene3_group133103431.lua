...
-- 怪物
monsters = {
	{ config_id = 431001, monster_id = 28050201, pos = { x = 41.6, y = 234.6, z = 1112.3 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 24, drop_tag = "魔法生物" },
	{ config_id = 431002, monster_id = 28050201, pos = { x = 47.6, y = 234.6, z = 1125.2 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 24, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 431003, gadget_id = 70360027, pos = { x = 47.7, y = 234.5, z = 1125.1 }, rot = { x = 0.0, y = 104.1, z = 0.0 }, level = 24 },
	{ config_id = 431004, gadget_id = 70360015, pos = { x = 41.9, y = 234.5, z = 1112.4 }, rot = { x = 0.0, y = 15.1, z = 0.0 }, level = 24 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_431005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_431005", action = "action_EVENT_ANY_MONSTER_DIE_431005" },
	{ name = "SELECT_OPTION_431006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_431006", action = "action_EVENT_SELECT_OPTION_431006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_431007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_431007", action = "action_EVENT_GADGET_STATE_CHANGE_431007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_431008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_431008", action = "action_EVENT_GADGET_STATE_CHANGE_431008", trigger_count = 0 },
	{ name = "GROUP_LOAD_431009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_431009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_431010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_431010", action = "action_EVENT_GADGET_STATE_CHANGE_431010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_431005", "SELECT_OPTION_431006", "GADGET_STATE_CHANGE_431007", "GADGET_STATE_CHANGE_431008", "GROUP_LOAD_431009", "GADGET_STATE_CHANGE_431010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_431005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103431, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_431010(context, evt)
	if 431004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_431010(context, evt)
