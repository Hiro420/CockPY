...
-- 怪物
monsters = {
	{ config_id = 156001, monster_id = 28050201, pos = { x = -377.3, y = 243.0, z = 743.6 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 156002, monster_id = 28050201, pos = { x = -365.3, y = 242.4, z = 749.5 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 156003, gadget_id = 70360027, pos = { x = -364.6, y = 242.4, z = 750.1 }, rot = { x = 4.4, y = 104.7, z = 14.7 }, level = 32 },
	{ config_id = 156004, gadget_id = 70360015, pos = { x = -377.0, y = 242.9, z = 743.7 }, rot = { x = 358.8, y = 15.2, z = 354.1 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_156005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_156005", action = "action_EVENT_ANY_MONSTER_DIE_156005" },
	{ name = "SELECT_OPTION_156006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_156006", action = "action_EVENT_SELECT_OPTION_156006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_156007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_156007", action = "action_EVENT_GADGET_STATE_CHANGE_156007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_156008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_156008", action = "action_EVENT_GADGET_STATE_CHANGE_156008", trigger_count = 0 },
	{ name = "GROUP_LOAD_156009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_156009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_156010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_156010", action = "action_EVENT_GADGET_STATE_CHANGE_156010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_156005", "SELECT_OPTION_156006", "GADGET_STATE_CHANGE_156007", "GADGET_STATE_CHANGE_156008", "GROUP_LOAD_156009", "GADGET_STATE_CHANGE_156010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_156005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133106156, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_156010(context, evt)
	if 156004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
