...
-- 装置
gadgets = {
	{ config_id = 192001, gadget_id = 70360007, pos = { x = -397.7, y = 247.4, z = 782.5 }, rot = { x = 351.0, y = 195.3, z = 10.1 }, level = 32 },
	{ config_id = 192002, gadget_id = 70211111, pos = { x = -438.0, y = 233.4, z = 793.3 }, rot = { x = 12.1, y = 89.9, z = 2.7 }, level = 32, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
...
function action_EVENT_GADGET_STATE_CHANGE_192003(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133106192, 3) then
		return -1
	end
