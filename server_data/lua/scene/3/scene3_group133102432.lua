...
-- 怪物
monsters = {
	{ config_id = 432001, monster_id = 28050201, pos = { x = 1894.1, y = 216.5, z = 633.6 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 432002, monster_id = 28050201, pos = { x = 1907.0, y = 216.5, z = 646.1 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 432003, gadget_id = 70360027, pos = { x = 1906.9, y = 216.5, z = 646.0 }, rot = { x = 0.0, y = 104.1, z = 0.0 }, level = 32 },
	{ config_id = 432004, gadget_id = 70360015, pos = { x = 1897.5, y = 216.5, z = 631.9 }, rot = { x = 0.0, y = 104.1, z = 0.0 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_432005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_432005", action = "action_EVENT_ANY_MONSTER_DIE_432005" },
	{ name = "SELECT_OPTION_432006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_432006", action = "action_EVENT_SELECT_OPTION_432006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_432007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_432007", action = "action_EVENT_GADGET_STATE_CHANGE_432007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_432008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_432008", action = "action_EVENT_GADGET_STATE_CHANGE_432008", trigger_count = 0 },
	{ name = "GROUP_LOAD_432009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_432009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_432010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_432010", action = "action_EVENT_GADGET_STATE_CHANGE_432010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_432005", "SELECT_OPTION_432006", "GADGET_STATE_CHANGE_432007", "GADGET_STATE_CHANGE_432008", "GROUP_LOAD_432009", "GADGET_STATE_CHANGE_432010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_432005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133102432, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_432010(context, evt)
	if 432004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_432010(context, evt)
