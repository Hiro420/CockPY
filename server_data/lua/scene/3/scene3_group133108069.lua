...
-- 怪物
monsters = {
	{ config_id = 69001, monster_id = 28050202, pos = { x = -337.2, y = 231.2, z = -947.6 }, rot = { x = 0.0, y = 135.7, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 69002, monster_id = 28050202, pos = { x = -329.4, y = 232.6, z = -965.4 }, rot = { x = 0.0, y = 147.8, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 69003, gadget_id = 70360027, pos = { x = -329.2, y = 232.5, z = -965.3 }, rot = { x = 1.9, y = 104.2, z = 3.3 }, level = 32 },
	{ config_id = 69004, gadget_id = 70360015, pos = { x = -336.9, y = 231.1, z = -947.5 }, rot = { x = 11.1, y = 13.9, z = 348.2 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_69005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_69005", action = "action_EVENT_ANY_MONSTER_DIE_69005" },
	{ name = "SELECT_OPTION_69006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_69006", action = "action_EVENT_SELECT_OPTION_69006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_69007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_69007", action = "action_EVENT_GADGET_STATE_CHANGE_69007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_69008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_69008", action = "action_EVENT_GADGET_STATE_CHANGE_69008", trigger_count = 0 },
	{ name = "GROUP_LOAD_69009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_69009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_69010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_69010", action = "action_EVENT_GADGET_STATE_CHANGE_69010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 69003, 69004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_69005", "SELECT_OPTION_69006", "GADGET_STATE_CHANGE_69007", "GADGET_STATE_CHANGE_69008", "GROUP_LOAD_69009", "GADGET_STATE_CHANGE_69010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_69005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133108069, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_69010(context, evt)
	if 69004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
