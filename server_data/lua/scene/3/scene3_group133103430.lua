...
-- 装置
gadgets = {
	{ config_id = 430001, gadget_id = 70310012, pos = { x = 8.1, y = 214.8, z = 1324.0 }, rot = { x = 0.0, y = 190.0, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 430002, gadget_id = 70310011, pos = { x = 7.3, y = 210.1, z = 1325.2 }, rot = { x = 0.0, y = 276.1, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 430003, gadget_id = 70310011, pos = { x = 11.4, y = 228.8, z = 1330.9 }, rot = { x = 0.0, y = 346.7, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 430004, gadget_id = 70310011, pos = { x = 0.5, y = 228.7, z = 1333.7 }, rot = { x = 0.0, y = 356.8, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 430005, gadget_id = 70310011, pos = { x = 4.4, y = 226.6, z = 1325.7 }, rot = { x = 0.0, y = 66.8, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 430006, gadget_id = 70211112, pos = { x = 8.2, y = 215.2, z = 1324.0 }, rot = { x = 0.0, y = 144.5, z = 0.0 }, level = 24, drop_tag = "解谜中级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}
