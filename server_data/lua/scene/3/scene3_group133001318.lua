...
-- 装置
gadgets = {
	{ config_id = 318001, gadget_id = 70620002, pos = { x = 1469.3, y = 274.6, z = -1381.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 10, isOneoff = true, persistent = true },
	{ config_id = 318002, gadget_id = 70211101, pos = { x = 1469.3, y = 274.5, z = -1381.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 10, drop_tag = "解谜低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 318004, shape = RegionShape.SPHERE, radius = 2, pos = { x = 1469.3, y = 277.4, z = -1381.4 } }
}
...
triggers = {
	...
	{ name = "ENTER_REGION_318004", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_318004", action = "action_EVENT_ENTER_REGION_318004" },
...
-- 触发条件
function condition_EVENT_ENTER_REGION_318004(context, evt)
	if evt.param1 ~= 318004 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_318004(context, evt)
