...
-- 怪物
monsters = {
	{ config_id = 984, monster_id = 20011001, pos = { x = 2324.9, y = 211.8, z = -1116.2 }, rot = { x = 0.0, y = 141.8, z = 0.0 }, level = 1, drop_tag = "史莱姆", disableWander = true }
}
...
-- 装置
gadgets = {
	{ config_id = 3213, gadget_id = 70211101, pos = { x = 2322.2, y = 211.4, z = -1121.6 }, rot = { x = 0.0, y = 108.1, z = 0.0 }, level = 2, drop_tag = "解谜低级蒙德", isOneoff = true }
}
