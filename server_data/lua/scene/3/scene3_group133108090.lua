...
-- 装置
gadgets = {
	{ config_id = 90001, gadget_id = 70360007, pos = { x = -147.2, y = 250.4, z = -100.7 }, rot = { x = 0.0, y = 271.2, z = 0.0 }, level = 19 },
	{ config_id = 90002, gadget_id = 70211111, pos = { x = -146.2, y = 252.4, z = -105.5 }, rot = { x = 0.0, y = 350.5, z = 0.0 }, level = 19, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
...
function action_EVENT_GADGET_STATE_CHANGE_90003(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133108090, 3) then
		return -1
	end
