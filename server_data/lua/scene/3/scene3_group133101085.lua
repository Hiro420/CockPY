...
-- 怪物
monsters = {
	{ config_id = 85001, monster_id = 28050201, pos = { x = 1240.2, y = 254.9, z = 1196.3 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 85002, monster_id = 28050201, pos = { x = 1249.9, y = 256.8, z = 1184.8 }, rot = { x = 353.8, y = 185.5, z = 343.5 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 85003, gadget_id = 70360027, pos = { x = 1249.9, y = 256.8, z = 1184.9 }, rot = { x = 23.7, y = 262.1, z = 359.3 }, level = 32 },
	{ config_id = 85004, gadget_id = 70360015, pos = { x = 1246.5, y = 255.8, z = 1196.8 }, rot = { x = 0.6, y = 16.3, z = 22.3 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_85005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_85005", action = "action_EVENT_ANY_MONSTER_DIE_85005" },
	{ name = "SELECT_OPTION_85006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_85006", action = "action_EVENT_SELECT_OPTION_85006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_85007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_85007", action = "action_EVENT_GADGET_STATE_CHANGE_85007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_85008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_85008", action = "action_EVENT_GADGET_STATE_CHANGE_85008", trigger_count = 0 },
	{ name = "GROUP_LOAD_85009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_85009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_85010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_85010", action = "action_EVENT_GADGET_STATE_CHANGE_85010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 85003, 85004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_85005", "SELECT_OPTION_85006", "GADGET_STATE_CHANGE_85007", "GADGET_STATE_CHANGE_85008", "GROUP_LOAD_85009", "GADGET_STATE_CHANGE_85010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_85005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133101085, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_85010(context, evt)
	if 85004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_85010(context, evt)
