...
-- 区域
regions = {
	{ config_id = 912001, shape = RegionShape.SPHERE, radius = 11, pos = { x = 2246.7, y = 210.0, z = -936.7 } }
}

-- 触发器
triggers = {
	{ name = "ENTER_REGION_912001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_912001", action = "action_EVENT_ENTER_REGION_912001" }
}
