...
-- 怪物
monsters = {
	{ config_id = 358001, monster_id = 28050201, pos = { x = 622.9, y = 221.6, z = 810.0 }, rot = { x = 9.2, y = 29.8, z = 5.2 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 358002, monster_id = 28050201, pos = { x = 617.6, y = 220.0, z = 825.9 }, rot = { x = 356.1, y = 26.6, z = 353.1 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 358003, gadget_id = 70360027, pos = { x = 617.6, y = 219.9, z = 825.7 }, rot = { x = 0.2, y = 99.2, z = 9.9 }, level = 32 },
	{ config_id = 358004, gadget_id = 70360015, pos = { x = 629.3, y = 222.6, z = 814.4 }, rot = { x = 343.5, y = 101.9, z = 358.3 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_358005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_358005", action = "action_EVENT_ANY_MONSTER_DIE_358005" },
	{ name = "SELECT_OPTION_358006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_358006", action = "action_EVENT_SELECT_OPTION_358006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_358007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_358007", action = "action_EVENT_GADGET_STATE_CHANGE_358007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_358008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_358008", action = "action_EVENT_GADGET_STATE_CHANGE_358008", trigger_count = 0 },
	{ name = "GROUP_LOAD_358009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_358009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_358010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_358010", action = "action_EVENT_GADGET_STATE_CHANGE_358010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_358005", "SELECT_OPTION_358006", "GADGET_STATE_CHANGE_358007", "GADGET_STATE_CHANGE_358008", "GROUP_LOAD_358009", "GADGET_STATE_CHANGE_358010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_358005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133104358, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_358010(context, evt)
	if 358004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
