...
-- 装置
gadgets = {
	{ config_id = 241001, gadget_id = 70360007, pos = { x = 688.1, y = 213.3, z = 1316.5 }, rot = { x = 4.8, y = 196.0, z = 357.0 }, level = 24 },
	{ config_id = 241002, gadget_id = 70211101, pos = { x = 709.6, y = 209.7, z = 1311.8 }, rot = { x = 0.0, y = 284.8, z = 0.0 }, level = 24, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
...
-- 触发器
triggers = {
	{ name = "GADGET_STATE_CHANGE_241003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_241003", action = "action_EVENT_GADGET_STATE_CHANGE_241003" },
	{ name = "GADGET_STATE_CHANGE_241004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_241004", action = "action_EVENT_GADGET_STATE_CHANGE_241004", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_241005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_241005", action = "action_EVENT_GADGET_STATE_CHANGE_241005", trigger_count = 0 },
	{ name = "GADGET_CREATE_241006", event = EventType.EVENT_GADGET_CREATE, source = "111", condition = "condition_EVENT_GADGET_CREATE_241006", action = "action_EVENT_GADGET_CREATE_241006", trigger_count = 0 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_241003(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103241, 3) then
		return -1
	end
