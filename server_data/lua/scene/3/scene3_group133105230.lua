...
-- 怪物
monsters = {
	{ config_id = 230001, monster_id = 28050201, pos = { x = 861.6, y = 274.7, z = -151.5 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 230002, monster_id = 28050201, pos = { x = 870.3, y = 275.0, z = -146.7 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 230003, gadget_id = 70360027, pos = { x = 870.3, y = 274.9, z = -146.7 }, rot = { x = 359.5, y = 104.0, z = 4.8 }, level = 32 },
	{ config_id = 230004, gadget_id = 70360015, pos = { x = 861.9, y = 274.6, z = -151.4 }, rot = { x = 357.6, y = 15.2, z = 354.8 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_230005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_230005", action = "action_EVENT_ANY_MONSTER_DIE_230005" },
	{ name = "SELECT_OPTION_230006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_230006", action = "action_EVENT_SELECT_OPTION_230006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_230007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_230007", action = "action_EVENT_GADGET_STATE_CHANGE_230007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_230008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_230008", action = "action_EVENT_GADGET_STATE_CHANGE_230008", trigger_count = 0 },
	{ name = "GROUP_LOAD_230009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_230009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_230010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_230010", action = "action_EVENT_GADGET_STATE_CHANGE_230010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_230005", "SELECT_OPTION_230006", "GADGET_STATE_CHANGE_230007", "GADGET_STATE_CHANGE_230008", "GROUP_LOAD_230009", "GADGET_STATE_CHANGE_230010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_230005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133105230, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_230010(context, evt)
	if 230004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_230010(context, evt)
