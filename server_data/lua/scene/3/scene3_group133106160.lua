...
-- 怪物
monsters = {
	{ config_id = 160001, monster_id = 28050201, pos = { x = -814.4, y = 223.6, z = 983.2 }, rot = { x = 0.0, y = 295.8, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 160002, monster_id = 28050201, pos = { x = -826.7, y = 220.6, z = 991.4 }, rot = { x = 0.0, y = 314.2, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 160003, gadget_id = 70360027, pos = { x = -826.9, y = 220.5, z = 991.7 }, rot = { x = 352.9, y = 103.5, z = 7.0 }, level = 32 },
	{ config_id = 160004, gadget_id = 70360015, pos = { x = -814.1, y = 223.5, z = 983.3 }, rot = { x = 1.3, y = 17.9, z = 9.5 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_160005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_160005", action = "action_EVENT_ANY_MONSTER_DIE_160005" },
	{ name = "SELECT_OPTION_160006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_160006", action = "action_EVENT_SELECT_OPTION_160006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_160007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_160007", action = "action_EVENT_GADGET_STATE_CHANGE_160007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_160008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_160008", action = "action_EVENT_GADGET_STATE_CHANGE_160008", trigger_count = 0 },
	{ name = "GROUP_LOAD_160009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_160009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_160010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_160010", action = "action_EVENT_GADGET_STATE_CHANGE_160010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_160005", "SELECT_OPTION_160006", "GADGET_STATE_CHANGE_160007", "GADGET_STATE_CHANGE_160008", "GROUP_LOAD_160009", "GADGET_STATE_CHANGE_160010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_160005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133106160, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_160010(context, evt)
	if 160004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_160010(context, evt)
