...
-- 装置
gadgets = {
	{ config_id = 187001, gadget_id = 70220032, pos = { x = 949.7, y = 371.0, z = 1648.2 }, rot = { x = 0.0, y = 324.2, z = 0.0 }, level = 24 },
	{ config_id = 187002, gadget_id = 70690006, pos = { x = 949.9, y = 371.0, z = 1648.2 }, rot = { x = 0.0, y = 174.5, z = 0.0 }, level = 24, isOneoff = true, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "GADGET_STATE_CHANGE_187003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_187003", action = "action_EVENT_GADGET_STATE_CHANGE_187003", trigger_count = 0 },
