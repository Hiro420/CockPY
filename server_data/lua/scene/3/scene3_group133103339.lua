...
-- 怪物
monsters = {
	{ config_id = 339001, monster_id = 28050201, pos = { x = 494.4, y = 300.0, z = 1556.3 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 339002, monster_id = 28050201, pos = { x = 481.7, y = 299.6, z = 1551.8 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 339003, gadget_id = 70360027, pos = { x = 481.8, y = 299.6, z = 1551.6 }, rot = { x = 1.5, y = 104.2, z = 5.0 }, level = 32 },
	{ config_id = 339004, gadget_id = 70360015, pos = { x = 494.7, y = 299.8, z = 1556.4 }, rot = { x = 0.0, y = 15.1, z = 0.0 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_339005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_339005", action = "action_EVENT_ANY_MONSTER_DIE_339005" },
	{ name = "SELECT_OPTION_339006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_339006", action = "action_EVENT_SELECT_OPTION_339006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_339007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_339007", action = "action_EVENT_GADGET_STATE_CHANGE_339007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_339008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_339008", action = "action_EVENT_GADGET_STATE_CHANGE_339008", trigger_count = 0 },
	{ name = "GROUP_LOAD_339009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_339009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_339010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_339010", action = "action_EVENT_GADGET_STATE_CHANGE_339010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_339005", "SELECT_OPTION_339006", "GADGET_STATE_CHANGE_339007", "GADGET_STATE_CHANGE_339008", "GROUP_LOAD_339009", "GADGET_STATE_CHANGE_339010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_339005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103339, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_339010(context, evt)
	if 339004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_339010(context, evt)
