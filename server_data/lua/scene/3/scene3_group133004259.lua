...
-- 区域
regions = {
	{ config_id = 299, shape = RegionShape.SPHERE, radius = 24.8, pos = { x = 2390.8, y = 226.6, z = -35.2 } }
}

-- 触发器
triggers = {
	{ name = "ENTER_REGION_299", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_299", action = "action_EVENT_ENTER_REGION_299", trigger_count = 0 }
}
