...
-- 怪物
monsters = {
	{ config_id = 333002, monster_id = 20030101, pos = { x = 1769.6, y = 205.8, z = 852.5 }, rot = { x = 0.0, y = 139.1, z = 0.0 }, level = 18, drop_id = 1000100 },
	{ config_id = 333003, monster_id = 20030101, pos = { x = 1767.8, y = 205.8, z = 849.1 }, rot = { x = 0.0, y = 52.9, z = 0.0 }, level = 18, drop_id = 1000100 }
}
...
-- 装置
gadgets = {
	{ config_id = 333004, gadget_id = 70211102, pos = { x = 1767.6, y = 205.0, z = 850.2 }, rot = { x = 0.0, y = 239.5, z = 0.0 }, level = 18, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 333005, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1767.6, y = 205.8, z = 850.3 } }
}
