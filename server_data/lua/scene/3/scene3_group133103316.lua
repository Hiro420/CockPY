...
-- 怪物
monsters = {
	{ config_id = 316001, monster_id = 28050201, pos = { x = 550.2, y = 198.4, z = 991.0 }, rot = { x = 348.5, y = 26.7, z = 26.7 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 316002, monster_id = 28050201, pos = { x = 546.2, y = 194.7, z = 1003.5 }, rot = { x = 3.3, y = 30.1, z = 20.9 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 316003, gadget_id = 70360027, pos = { x = 546.1, y = 194.7, z = 1003.5 }, rot = { x = 356.6, y = 103.5, z = 13.6 }, level = 32 },
	{ config_id = 316004, gadget_id = 70360015, pos = { x = 539.2, y = 198.4, z = 988.5 }, rot = { x = 17.4, y = 15.4, z = 2.1 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_316005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_316005", action = "action_EVENT_ANY_MONSTER_DIE_316005" },
	{ name = "SELECT_OPTION_316006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_316006", action = "action_EVENT_SELECT_OPTION_316006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_316007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_316007", action = "action_EVENT_GADGET_STATE_CHANGE_316007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_316008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_316008", action = "action_EVENT_GADGET_STATE_CHANGE_316008", trigger_count = 0 },
	{ name = "GROUP_LOAD_316009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_316009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_316010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_316010", action = "action_EVENT_GADGET_STATE_CHANGE_316010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_316005", "SELECT_OPTION_316006", "GADGET_STATE_CHANGE_316007", "GADGET_STATE_CHANGE_316008", "GROUP_LOAD_316009", "GADGET_STATE_CHANGE_316010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_316005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103316, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_316010(context, evt)
	if 316004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_316010(context, evt)
