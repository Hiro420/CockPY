...
-- 怪物
monsters = {
	{ config_id = 177, monster_id = 20011501, pos = { x = 686.8, y = 251.6, z = -285.3 }, rot = { x = 0.0, y = 117.9, z = 0.0 }, level = 26, drop_tag = "史莱姆" }
}
...
-- 区域
regions = {
	{ config_id = 132, shape = RegionShape.SPHERE, radius = 5, pos = { x = 687.3, y = 247.3, z = -285.4 } }
}
