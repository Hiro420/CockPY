...
-- 怪物
monsters = {
	{ config_id = 91001, monster_id = 28050202, pos = { x = -281.2, y = 213.3, z = 1140.8 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 91002, monster_id = 28050202, pos = { x = -263.9, y = 214.2, z = 1148.1 }, rot = { x = 0.0, y = 45.6, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 91003, gadget_id = 70360027, pos = { x = -263.6, y = 214.2, z = 1148.1 }, rot = { x = 6.2, y = 103.5, z = 349.7 }, level = 32 },
	{ config_id = 91004, gadget_id = 70360015, pos = { x = -280.9, y = 213.1, z = 1140.9 }, rot = { x = 348.1, y = 15.4, z = 356.7 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_91005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_91005", action = "action_EVENT_ANY_MONSTER_DIE_91005" },
	{ name = "SELECT_OPTION_91006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_91006", action = "action_EVENT_SELECT_OPTION_91006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_91007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_91007", action = "action_EVENT_GADGET_STATE_CHANGE_91007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_91008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_91008", action = "action_EVENT_GADGET_STATE_CHANGE_91008", trigger_count = 0 },
	{ name = "GROUP_LOAD_91009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_91009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_91010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_91010", action = "action_EVENT_GADGET_STATE_CHANGE_91010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 91003, 91004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_91005", "SELECT_OPTION_91006", "GADGET_STATE_CHANGE_91007", "GADGET_STATE_CHANGE_91008", "GROUP_LOAD_91009", "GADGET_STATE_CHANGE_91010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_91005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133106091, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_91010(context, evt)
	if 91004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_91010(context, evt)
