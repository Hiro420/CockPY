...
-- 装置
gadgets = {
	{ config_id = 584001, gadget_id = 70211101, pos = { x = 1759.7, y = 245.1, z = 153.0 }, rot = { x = 0.0, y = 211.3, z = 0.0 }, level = 16, chest_drop_id = 1000600, drop_count = 1, state = GadgetState.ChestLocked, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 584002, gadget_id = 70220021, pos = { x = 1758.9, y = 244.7, z = 153.3 }, rot = { x = 5.6, y = 13.0, z = 0.1 }, level = 16, persistent = true }
}
...
-- 触发器
triggers = {
	{ name = "ANY_GADGET_DIE_584003", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_584003", action = "action_EVENT_ANY_GADGET_DIE_584003", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_584004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_584004", action = "action_EVENT_GADGET_STATE_CHANGE_584004", trigger_count = 0 }
}
