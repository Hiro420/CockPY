...
-- 怪物
monsters = {
	{ config_id = 279001, monster_id = 28050201, pos = { x = 802.1, y = 327.4, z = 1506.0 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 279002, monster_id = 28050201, pos = { x = 816.0, y = 328.8, z = 1512.0 }, rot = { x = 348.2, y = 30.5, z = 4.5 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 279003, gadget_id = 70360027, pos = { x = 816.1, y = 328.8, z = 1511.9 }, rot = { x = 346.8, y = 103.4, z = 5.8 }, level = 32 },
	{ config_id = 279004, gadget_id = 70360015, pos = { x = 802.3, y = 327.2, z = 1506.1 }, rot = { x = 14.9, y = 17.5, z = 13.5 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_279005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_279005", action = "action_EVENT_ANY_MONSTER_DIE_279005" },
	{ name = "SELECT_OPTION_279006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_279006", action = "action_EVENT_SELECT_OPTION_279006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_279007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_279007", action = "action_EVENT_GADGET_STATE_CHANGE_279007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_279008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_279008", action = "action_EVENT_GADGET_STATE_CHANGE_279008", trigger_count = 0 },
	{ name = "GROUP_LOAD_279009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_279009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_279010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_279010", action = "action_EVENT_GADGET_STATE_CHANGE_279010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_279005", "SELECT_OPTION_279006", "GADGET_STATE_CHANGE_279007", "GADGET_STATE_CHANGE_279008", "GROUP_LOAD_279009", "GADGET_STATE_CHANGE_279010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_279005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103279, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_279010(context, evt)
	if 279004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
