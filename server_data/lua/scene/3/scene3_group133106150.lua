...
-- 装置
gadgets = {
	{ config_id = 150001, gadget_id = 70360008, pos = { x = -701.1, y = 210.7, z = 1154.1 }, rot = { x = 0.0, y = 268.8, z = 0.0 }, level = 32 },
	{ config_id = 150002, gadget_id = 70360011, pos = { x = -701.8, y = 214.6, z = 1142.8 }, rot = { x = 0.0, y = 302.6, z = 0.0 }, level = 32 },
	{ config_id = 150003, gadget_id = 70360012, pos = { x = -699.3, y = 214.6, z = 1143.8 }, rot = { x = 0.0, y = 240.7, z = 0.0 }, level = 32 },
	{ config_id = 150004, gadget_id = 70360013, pos = { x = -704.7, y = 214.7, z = 1142.1 }, rot = { x = 0.0, y = 136.9, z = 0.0 }, level = 32 },
	{ config_id = 150005, gadget_id = 70360014, pos = { x = -701.8, y = 214.6, z = 1142.8 }, rot = { x = 0.0, y = 187.8, z = 0.0 }, level = 32, route_id = 310600057 },
	{ config_id = 150006, gadget_id = 70360014, pos = { x = -699.3, y = 214.6, z = 1143.9 }, rot = { x = 0.0, y = 287.7, z = 0.0 }, level = 32, route_id = 310600058 },
	{ config_id = 150007, gadget_id = 70360014, pos = { x = -704.7, y = 214.7, z = 1142.1 }, rot = { x = 0.0, y = 299.1, z = 0.0 }, level = 32, route_id = 310600059 },
	{ config_id = 150008, gadget_id = 70211111, pos = { x = -701.1, y = 211.0, z = 1151.7 }, rot = { x = 4.5, y = 360.0, z = 355.5 }, level = 32, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}
