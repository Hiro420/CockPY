...
-- 装置
gadgets = {
	{ config_id = 591001, gadget_id = 70900201, pos = { x = 1780.3, y = 200.2, z = 70.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 16 }
}

-- 区域
regions = {
	{ config_id = 591002, shape = RegionShape.SPHERE, radius = 60, pos = { x = 1784.5, y = 200.0, z = 132.9 } }
}

-- 触发器
triggers = {
	{ name = "ENTER_REGION_591002", event = EventType.EVENT_ENTER_REGION, source = "1", condition = "condition_EVENT_ENTER_REGION_591002", action = "action_EVENT_ENTER_REGION_591002", trigger_count = 0 },
	{ name = "VARIABLE_CHANGE_591004", event = EventType.EVENT_VARIABLE_CHANGE, source = "133102592", condition = "condition_EVENT_VARIABLE_CHANGE_591004", action = "action_EVENT_VARIABLE_CHANGE_591004", trigger_count = 0 }
}
