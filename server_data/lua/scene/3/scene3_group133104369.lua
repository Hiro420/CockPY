...
-- 怪物
monsters = {
	{ config_id = 369001, monster_id = 28050201, pos = { x = 556.3, y = 200.3, z = 198.1 }, rot = { x = 2.0, y = 30.3, z = 12.4 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 369002, monster_id = 28050201, pos = { x = 555.5, y = 202.8, z = 180.0 }, rot = { x = 355.6, y = 29.8, z = 353.8 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 369003, gadget_id = 70360027, pos = { x = 555.6, y = 202.7, z = 179.9 }, rot = { x = 359.6, y = 105.0, z = 9.9 }, level = 32 },
	{ config_id = 369004, gadget_id = 70360015, pos = { x = 556.4, y = 200.1, z = 198.2 }, rot = { x = 349.1, y = 104.2, z = 3.6 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_369005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_369005", action = "action_EVENT_ANY_MONSTER_DIE_369005" },
	{ name = "SELECT_OPTION_369006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_369006", action = "action_EVENT_SELECT_OPTION_369006", trigger_count = 0 },
	...
	{ name = "GROUP_LOAD_369009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_369009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_369010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_369010", action = "action_EVENT_GADGET_STATE_CHANGE_369010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_369005", "SELECT_OPTION_369006", "GADGET_STATE_CHANGE_369007", "GADGET_STATE_CHANGE_369008", "GROUP_LOAD_369009", "GADGET_STATE_CHANGE_369010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_369005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133104369, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_369010(context, evt)
	if 369004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
