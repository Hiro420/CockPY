...
-- 怪物
monsters = {
	{ config_id = 454001, monster_id = 21011001, pos = { x = 152.7, y = 206.9, z = 1217.2 }, rot = { x = 0.0, y = 223.4, z = 0.0 }, level = 24, drop_id = 1000100, pose_id = 32 },
	{ config_id = 454008, monster_id = 21011001, pos = { x = 130.4, y = 199.4, z = 1206.7 }, rot = { x = 0.0, y = 63.5, z = 0.0 }, level = 24, drop_id = 1000100, pose_id = 32 },
	{ config_id = 454009, monster_id = 21010901, pos = { x = 133.0, y = 203.7, z = 1195.5 }, rot = { x = 0.0, y = 45.6, z = 0.0 }, level = 24, drop_id = 1000100, pose_id = 32 },
	{ config_id = 454010, monster_id = 21010701, pos = { x = 148.6, y = 198.1, z = 1197.9 }, rot = { x = 0.0, y = 4.7, z = 0.0 }, level = 24, drop_id = 1000100 }
}
...
-- 装置
gadgets = {
	{ config_id = 454002, gadget_id = 70360047, pos = { x = 150.2, y = 197.2, z = 1216.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, drop_tag = "战斗高级璃月", state = GadgetState.Action01, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 454003, gadget_id = 70360001, pos = { x = 150.3, y = 198.1, z = 1216.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24 }
}
