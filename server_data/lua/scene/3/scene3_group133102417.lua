...
-- 怪物
monsters = {
	{ config_id = 417001, monster_id = 28050201, pos = { x = 1125.8, y = 202.0, z = 323.2 }, rot = { x = 354.0, y = 115.5, z = 358.1 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 417002, monster_id = 28050201, pos = { x = 1127.8, y = 202.8, z = 336.7 }, rot = { x = 334.0, y = 32.0, z = 348.7 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 417003, gadget_id = 70360027, pos = { x = 1127.9, y = 202.5, z = 336.5 }, rot = { x = 355.3, y = 104.6, z = 349.7 }, level = 32 },
	{ config_id = 417004, gadget_id = 70360015, pos = { x = 1125.6, y = 201.8, z = 323.2 }, rot = { x = 348.2, y = 105.1, z = 359.6 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_417005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_417005", action = "action_EVENT_ANY_MONSTER_DIE_417005" },
	{ name = "SELECT_OPTION_417006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_417006", action = "action_EVENT_SELECT_OPTION_417006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_417007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_417007", action = "action_EVENT_GADGET_STATE_CHANGE_417007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_417008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_417008", action = "action_EVENT_GADGET_STATE_CHANGE_417008", trigger_count = 0 },
	{ name = "GROUP_LOAD_417009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_417009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_417010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_417010", action = "action_EVENT_GADGET_STATE_CHANGE_417010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_417005", "SELECT_OPTION_417006", "GADGET_STATE_CHANGE_417007", "GADGET_STATE_CHANGE_417008", "GROUP_LOAD_417009", "GADGET_STATE_CHANGE_417010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_417005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133102417, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_417010(context, evt)
	if 417004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
