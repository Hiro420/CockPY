...
-- 怪物
monsters = {
	{ config_id = 124001, monster_id = 20010901, pos = { x = 1313.2, y = 201.0, z = 1035.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 22, drop_tag = "史莱姆" }
}
...
-- 装置
gadgets = {
	{ config_id = 124002, gadget_id = 70510013, pos = { x = 1313.2, y = 201.0, z = 1035.7 }, rot = { x = 0.0, y = 319.8, z = 0.0 }, level = 32, isOneoff = true, persistent = true },
	{ config_id = 124003, gadget_id = 70211101, pos = { x = 1314.5, y = 201.1, z = 1037.9 }, rot = { x = 350.4, y = 0.8, z = 351.1 }, level = 22, drop_tag = "解谜低级璃月", showcutscene = true, isOneoff = true, persistent = true }
}
