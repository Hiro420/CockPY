...
-- 怪物
monsters = {
	{ config_id = 160, monster_id = 20011501, pos = { x = 625.7, y = 297.4, z = -224.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 25, drop_tag = "史莱姆" }
}
...
-- 区域
regions = {
	{ config_id = 110, shape = RegionShape.SPHERE, radius = 5, pos = { x = 626.0, y = 295.7, z = -224.4 } }
}
