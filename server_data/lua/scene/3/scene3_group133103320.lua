...
-- 怪物
monsters = {
	{ config_id = 320001, monster_id = 28050201, pos = { x = 396.1, y = 277.8, z = 1295.4 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 320002, monster_id = 28050201, pos = { x = 390.2, y = 269.0, z = 1328.7 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 320003, gadget_id = 70360027, pos = { x = 390.4, y = 268.9, z = 1328.6 }, rot = { x = 0.0, y = 104.1, z = 0.0 }, level = 32 },
	{ config_id = 320004, gadget_id = 70360015, pos = { x = 396.4, y = 277.7, z = 1295.5 }, rot = { x = 350.6, y = 15.3, z = 357.4 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_320005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_320005", action = "action_EVENT_ANY_MONSTER_DIE_320005" },
	{ name = "SELECT_OPTION_320006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_320006", action = "action_EVENT_SELECT_OPTION_320006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_320007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_320007", action = "action_EVENT_GADGET_STATE_CHANGE_320007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_320008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_320008", action = "action_EVENT_GADGET_STATE_CHANGE_320008", trigger_count = 0 },
	{ name = "GROUP_LOAD_320009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_320009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_320010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_320010", action = "action_EVENT_GADGET_STATE_CHANGE_320010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_320005", "SELECT_OPTION_320006", "GADGET_STATE_CHANGE_320007", "GADGET_STATE_CHANGE_320008", "GROUP_LOAD_320009", "GADGET_STATE_CHANGE_320010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_320005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103320, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_320010(context, evt)
	if 320004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_320010(context, evt)
