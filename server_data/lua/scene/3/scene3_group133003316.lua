...
-- 怪物
monsters = {
	{ config_id = 1031, monster_id = 20011101, pos = { x = 2706.1, y = 273.7, z = -1581.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 13, drop_tag = "史莱姆" },
	{ config_id = 1032, monster_id = 20011001, pos = { x = 2708.9, y = 273.9, z = -1580.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 13, drop_tag = "史莱姆" },
	{ config_id = 1033, monster_id = 20011001, pos = { x = 2706.5, y = 273.7, z = -1578.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 13, drop_tag = "史莱姆" }
}
...
-- 装置
gadgets = {
	{ config_id = 3286, gadget_id = 70211002, pos = { x = 2706.9, y = 273.7, z = -1580.0 }, rot = { x = 0.0, y = 322.5, z = 0.0 }, level = 30, drop_tag = "战斗低级蒙德", state = GadgetState.ChestLocked, isOneoff = true, persistent = true }
}
