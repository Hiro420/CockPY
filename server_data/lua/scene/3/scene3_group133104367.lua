...
-- 怪物
monsters = {
	{ config_id = 367001, monster_id = 28050201, pos = { x = 376.0, y = 201.4, z = 454.3 }, rot = { x = 354.7, y = 29.6, z = 2.1 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 367002, monster_id = 28050201, pos = { x = 357.0, y = 201.6, z = 458.6 }, rot = { x = 343.8, y = 31.3, z = 344.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 367003, gadget_id = 70360027, pos = { x = 357.1, y = 201.6, z = 458.5 }, rot = { x = 5.6, y = 103.8, z = 355.9 }, level = 32 },
	{ config_id = 367004, gadget_id = 70360015, pos = { x = 375.9, y = 201.3, z = 454.3 }, rot = { x = 358.3, y = 104.3, z = 355.9 }, level = 32 }
}
...
triggers = {
	...
	{ name = "SELECT_OPTION_367006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_367006", action = "action_EVENT_SELECT_OPTION_367006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_367007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_367007", action = "action_EVENT_GADGET_STATE_CHANGE_367007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_367008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_367008", action = "action_EVENT_GADGET_STATE_CHANGE_367008", trigger_count = 0 },
	{ name = "GROUP_LOAD_367009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_367009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_367010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_367010", action = "action_EVENT_GADGET_STATE_CHANGE_367010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_367005", "SELECT_OPTION_367006", "GADGET_STATE_CHANGE_367007", "GADGET_STATE_CHANGE_367008", "GROUP_LOAD_367009", "GADGET_STATE_CHANGE_367010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_367005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133104367, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_367010(context, evt)
	if 367004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_367010(context, evt)
