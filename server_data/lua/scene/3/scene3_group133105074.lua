...
-- 怪物
monsters = {
	{ config_id = 159, monster_id = 20010901, pos = { x = 641.6, y = 279.6, z = -178.9 }, rot = { x = 0.0, y = 111.9, z = 0.0 }, level = 25, drop_tag = "史莱姆" }
}
...
-- 区域
regions = {
	{ config_id = 104, shape = RegionShape.SPHERE, radius = 5, pos = { x = 640.3, y = 273.8, z = -178.8 } }
}
