...
-- 怪物
monsters = {
	{ config_id = 231001, monster_id = 28050201, pos = { x = 773.6, y = 251.8, z = -332.4 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 231002, monster_id = 28050201, pos = { x = 770.4, y = 254.0, z = -341.0 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 231003, gadget_id = 70360027, pos = { x = 770.8, y = 253.7, z = -340.7 }, rot = { x = 356.2, y = 102.5, z = 20.2 }, level = 32 },
	{ config_id = 231004, gadget_id = 70360015, pos = { x = 773.9, y = 251.7, z = -332.3 }, rot = { x = 5.7, y = 15.7, z = 12.5 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_231005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_231005", action = "action_EVENT_ANY_MONSTER_DIE_231005" },
	{ name = "SELECT_OPTION_231006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_231006", action = "action_EVENT_SELECT_OPTION_231006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_231007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_231007", action = "action_EVENT_GADGET_STATE_CHANGE_231007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_231008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_231008", action = "action_EVENT_GADGET_STATE_CHANGE_231008", trigger_count = 0 },
	{ name = "GROUP_LOAD_231009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_231009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_231010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_231010", action = "action_EVENT_GADGET_STATE_CHANGE_231010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_231005", "SELECT_OPTION_231006", "GADGET_STATE_CHANGE_231007", "GADGET_STATE_CHANGE_231008", "GROUP_LOAD_231009", "GADGET_STATE_CHANGE_231010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_231005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133105231, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_231010(context, evt)
	if 231004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_231010(context, evt)
