...
-- 怪物
monsters = {
	{ config_id = 235001, monster_id = 28050201, pos = { x = 732.1, y = 404.6, z = 1856.8 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 235002, monster_id = 28050201, pos = { x = 727.0, y = 407.2, z = 1840.0 }, rot = { x = 346.3, y = 320.3, z = 350.5 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 235003, gadget_id = 70360027, pos = { x = 727.2, y = 407.0, z = 1840.0 }, rot = { x = 10.5, y = 33.1, z = 352.1 }, level = 32 },
	{ config_id = 235004, gadget_id = 70360015, pos = { x = 732.2, y = 404.5, z = 1856.4 }, rot = { x = 15.4, y = 12.0, z = 346.7 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_235005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_235005", action = "action_EVENT_ANY_MONSTER_DIE_235005" },
	{ name = "SELECT_OPTION_235006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_235006", action = "action_EVENT_SELECT_OPTION_235006", trigger_count = 0 },
	...
	{ name = "GADGET_STATE_CHANGE_235008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_235008", action = "action_EVENT_GADGET_STATE_CHANGE_235008", trigger_count = 0 },
	{ name = "GROUP_LOAD_235009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_235009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_235010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_235010", action = "action_EVENT_GADGET_STATE_CHANGE_235010", trigger_count = 0 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_235005", "SELECT_OPTION_235006", "GADGET_STATE_CHANGE_235007", "GADGET_STATE_CHANGE_235008", "GROUP_LOAD_235009", "GADGET_STATE_CHANGE_235010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_235005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133103235, 2) then
		return -1
	end
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_235010(context, evt)
	if 235004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_235010(context, evt)
