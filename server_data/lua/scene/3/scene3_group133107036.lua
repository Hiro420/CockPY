...
-- 怪物
monsters = {
	{ config_id = 36001, monster_id = 28050201, pos = { x = -607.2, y = 319.3, z = 620.2 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物" },
	{ config_id = 36002, monster_id = 28050201, pos = { x = -607.2, y = 331.8, z = 600.7 }, rot = { x = 0.0, y = 29.5, z = 0.0 }, level = 32, drop_tag = "魔法生物", pose_id = 3 }
}
...
-- 装置
gadgets = {
	{ config_id = 36003, gadget_id = 70360027, pos = { x = -607.2, y = 331.8, z = 600.6 }, rot = { x = 328.5, y = 95.0, z = 25.4 }, level = 32 },
	{ config_id = 36004, gadget_id = 70360015, pos = { x = -609.4, y = 319.7, z = 618.2 }, rot = { x = 22.1, y = 22.4, z = 24.9 }, level = 32 }
}
...
-- 触发器
triggers = {
	{ name = "ANY_MONSTER_DIE_36005", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_36005", action = "action_EVENT_ANY_MONSTER_DIE_36005" },
	{ name = "SELECT_OPTION_36006", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_36006", action = "action_EVENT_SELECT_OPTION_36006", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_36007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_36007", action = "action_EVENT_GADGET_STATE_CHANGE_36007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_36008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_36008", action = "action_EVENT_GADGET_STATE_CHANGE_36008", trigger_count = 0 },
	{ name = "GROUP_LOAD_36009", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_36009", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_36010", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_36010", action = "action_EVENT_GADGET_STATE_CHANGE_36010", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 36003, 36004 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_36005", "SELECT_OPTION_36006", "GADGET_STATE_CHANGE_36007", "GADGET_STATE_CHANGE_36008", "GROUP_LOAD_36009", "GADGET_STATE_CHANGE_36010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_36005(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133107036, 2) then
		return -1
	end
...
function condition_EVENT_GADGET_STATE_CHANGE_36010(context, evt)
	if 36004 ~= evt.param2 or GadgetState.Action01 ~= evt.param1 then
		return false
	end
