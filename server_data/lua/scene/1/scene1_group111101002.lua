...
-- 装置
gadgets = {
	{ config_id = 2001, gadget_id = 70310012, pos = { x = 2525.7, y = 213.9, z = -1374.9 }, rot = { x = 0.0, y = 190.0, z = 0.0 }, level = 1, persistent = true },
	{ config_id = 2002, gadget_id = 70310011, pos = { x = 2527.6, y = 214.4, z = -1377.7 }, rot = { x = 0.0, y = 276.1, z = 0.0 }, level = 1, persistent = true },
	{ config_id = 2003, gadget_id = 70310011, pos = { x = 2514.7, y = 214.4, z = -1373.7 }, rot = { x = 0.0, y = 317.5, z = 0.0 }, level = 1, persistent = true },
	{ config_id = 2004, gadget_id = 70310011, pos = { x = 2528.0, y = 212.4, z = -1364.9 }, rot = { x = 0.0, y = 257.6, z = 0.0 }, level = 1, persistent = true },
	{ config_id = 2005, gadget_id = 70310011, pos = { x = 2538.8, y = 212.8, z = -1377.3 }, rot = { x = 0.0, y = 14.1, z = 0.0 }, level = 1, persistent = true },
	{ config_id = 2006, gadget_id = 70211112, pos = { x = 2525.8, y = 214.4, z = -1374.9 }, rot = { x = 0.0, y = 270.4, z = 0.0 }, level = 1, chest_drop_id = 15504, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}
